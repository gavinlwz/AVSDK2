...
#define FFMPEG_CONFIGURATION "--enable-cross-compile --target-os=darwin --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS.sdk --cpu=cortex-a9 --arch=arm --enable-asm --disable-armv5te --disable-armv6 --disable-armv6t2 --enable-neon --prefix=/Users/mac/Documents/code/trunk/videoSDKMain/youme_voice_engine/ffmpegPlayer/ffmpeg-2.2.3/../libs/apple/ios_arm32 --cc=/Applications/Xcode.app/Contents/Developer/usr/bin/gcc --as='gas-preprocessor.pl /Applications/Xcode.app/Contents/Developer/usr/bin/gcc' --extra-cflags='-arch armv7 -miphoneos-version-min=6.0 -fembed-bitcode-marker' --extra-cflags='-I/Users/mac/Documents/code/trunk/videoSDKMain/youme_voice_engine/ffmpegPlayer/ffmpeg-2.2.3/../ffmpeg-external-libs/libs-apple-ios-arm32/libx264/include -DBUILD_CONFIG_TYPE=audio' --extra-ldflags=-L/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS.sdk/usr/lib/system --extra-ldflags='-arch armv7 -miphoneos-version-min=6.0' --extra-ldflags=-L/Users/mac/Documents/code/trunk/videoSDKMain/youme_voice_engine/ffmpegPlayer/ffmpeg-2.2.3/../ffmpeg-external-libs/libs-apple-ios-arm32/libx264/lib --pkg-config=/Users/mac/Documents/code/trunk/videoSDKMain/youme_voice_engine/ffmpegPlayer/ffmpeg-2.2.3/../ffmpeg-external-libs/pkg-config-apple-ios-arm32 --disable-doc --disable-ffmpeg --disable-ffprobe --disable-ffplay --disable-ffserver --disable-avfilter --disable-avdevice --disable-muxers --disable-filters --disable-bsfs --disable-devices --disable-avdevice --disable-encoders --disable-decoders --disable-demuxers --disable-parsers --disable-protocols --disable-swresample --disable-swscale --disable-postproc --disable-iconv --enable-demuxer=mp3 --enable-demuxer=aac --enable-decoder=mp2 --enable-decoder=mp3 --enable-decoder=aac --enable-parser=mpegaudio --enable-parser=aac --enable-protocol=file --enable-decoder=h264 --enable-demuxer=h264 --enable-parser=h264 --enable-gpl --enable-libx264"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2015
#define FFMPEG_DATADIR "/Users/mac/Documents/code/trunk/videoSDKMain/youme_voice_engine/ffmpegPlayer/ffmpeg-2.2.3/../libs/apple/ios_arm32/share/ffmpeg"
#define AVCONV_DATADIR "/Users/mac/Documents/code/trunk/videoSDKMain/youme_voice_engine/ffmpegPlayer/ffmpeg-2.2.3/../libs/apple/ios_arm32/share/ffmpeg"
...
#define CONFIG_SRT_EXTERNAL_DEMUXER 0
