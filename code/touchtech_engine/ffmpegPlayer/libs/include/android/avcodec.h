...
#define AV_PKT_FLAG_HLS_NEW_SEGMENT       0x1000 ///< The packet is the first one of a HLS segment
#define AV_PKT_FLAG_HLS_DISCONTINUITY     0x2000 ///< The packet is the first one after receiving an HLS DISCONTINUITY tag
...
typedef struct AVSubtitleRect {
	...
	//the len of subtitle text
	int text_len;

	//the flags of unicode encode type;
	int UnicodeFlags;
} AVSubtitleRect;
