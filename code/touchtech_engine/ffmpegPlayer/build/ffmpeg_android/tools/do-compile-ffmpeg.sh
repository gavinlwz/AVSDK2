...
FF_MODULE_DIRS="compat libavcodec libavformat libavutil"
...
FF_SOURCE=$FF_BUILD_ROOT/../../FFmpeg-release-3.3
...
if [ "$FF_ARCH" = "armv7a" ]; then
    ...
    FF_INSTALL_LIBS=$FF_BUILD_ROOT/../../libs/android/armeabi-v7a/lib
    FF_INSTALL_INCLUDE=$FF_BUILD_ROOT/../../libs/include

    X264_INCLUDE=$FF_BUILD_ROOT/../../libs/android/armeabi-v7a/lib/include
    X264_LIBS=$FF_BUILD_ROOT/../../libs/android/armeabi-v7a/lib/libx264
    ...
    FF_ASSEMBLER_SUB_DIRS="arm"
    FF_INSTALL_LIBS=$FF_BUILD_ROOT/../../libs/android/armeabi/lib
    FF_INSTALL_INCLUDE=$FF_BUILD_ROOT/../../libs/include

    X264_INCLUDE=$FF_BUILD_ROOT/../../libs/android/armeabi/lib/include
    X264_LIBS=$FF_BUILD_ROOT/../../libs/android/armeabi/lib/libx264
    ...
    FF_CFG_FLAGS="$FF_CFG_FLAGS --arch=x86 --cpu=i686 --disable-yasm --disable-sse2 --disable-mmxext --disable-mmx"

    FF_EXTRA_CFLAGS="$FF_EXTRA_CFLAGS -march=atom -msse3 -ffast-math -mfpmath=sse"
    FF_EXTRA_LDFLAGS="$FF_EXTRA_LDFLAGS"

    FF_ASSEMBLER_SUB_DIRS="x86"
    FF_INSTALL_LIBS=$FF_BUILD_ROOT/../../libs/android/x86/lib
    FF_INSTALL_INCLUDE=$FF_BUILD_ROOT/../../libs/include

    X264_INCLUDE=$FF_BUILD_ROOT/../../libs/android/x86/lib/include
    X264_LIBS=$FF_BUILD_ROOT/../../libs/android/x86/lib/libx264
    ...
    FF_CFG_FLAGS="$FF_CFG_FLAGS --arch=x86_64 --disable-yasm --disable-sse2"
    ...
    X264_INCLUDE=$FF_BUILD_ROOT/../../libs/android/x86_64/lib/include
    X264_LIBS=$FF_BUILD_ROOT/../../libs/android/x86_64/lib/libx264
    ...
    FF_INSTALL_LIBS=$FF_BUILD_ROOT/../../libs/android/arm64-v8a/lib
    FF_INSTALL_INCLUDE=$FF_BUILD_ROOT/../../libs/include

    X264_INCLUDE=$FF_BUILD_ROOT/../../libs/android/arm64-v8a/lib/include
    X264_LIBS=$FF_BUILD_ROOT/../../libs/android/arm64-v8a/lib/libx264
else
...
FF_CFLAGS="$FF_CFLAGS -I$X264_INCLUDE "
FF_DEP_LIBS="$FF_DEP_LIBS -L$X264_LIBS"
...
echo "--------------------"
cp config.* $FF_PREFIX
make -j8 $FF_MAKE_FLAGS > /dev/null
make install
