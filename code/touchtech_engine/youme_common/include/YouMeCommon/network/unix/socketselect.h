...
#include "YouMeCommon/network/unix/socketpoll.h"
...
class SocketSelect {
  public:
    SocketSelect(youmecommon::SocketBreaker& _breaker, bool _autoclear = false);
    ...
    youmecommon::SocketBreaker& Breaker();

    youmecommon::SocketPoll&  Poll();
  ...
  protected:
    youmecommon::SocketPoll  socket_poll_;
};
