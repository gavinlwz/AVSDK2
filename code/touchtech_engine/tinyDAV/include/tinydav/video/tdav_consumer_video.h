...
typedef struct tdav_consumer_video_s
{
    ...
    videoRenderCb_t consumer_callback;
}
...
TINYDAV_API int tdav_consumer_video_put(tdav_consumer_video_t* self, const void* data, tsk_size_t data_size, tsk_object_t* proto_hdr);
