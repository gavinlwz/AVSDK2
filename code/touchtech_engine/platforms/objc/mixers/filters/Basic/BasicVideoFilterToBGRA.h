...
//
#ifndef videocore_BasicVideoFilterToBGRA_h
#define videocore_BasicVideoFilterToBGRA_h

#include "../IVideoFilter.h"

namespace videocore {
    namespace filters {
        class BasicVideoFilterToBGRA : public IVideoFilter {
            
        public:
            BasicVideoFilterToBGRA();
            ~BasicVideoFilterToBGRA();
        
        public:
            virtual void initialize();
            virtual bool initialized() const { return m_initialized; };
            virtual std::string const name() { return VIDEO_FILTER_NAME_TOBGRA; };
            virtual void bind();
            virtual void unbind();
...
#endif /* defined(videocore_BasicVideoFilterToBGRA_h) */
