...
#define WM_RENDER_UPDATE                      (WM_USER + 0x101)
#define WM_RENDER_CREATE_LOCAL_PREVIEW        (WM_USER + 0x102)
#define WM_RENDER_DELETE_LOCAL_PREVIEW        (WM_USER + 0x103)
#define WM_RENDER_CREATE_RENDER               (WM_USER + 0x104)
#define WM_RENDER_DELETE_RENDER               (WM_USER + 0x105)
#define WM_RENDER_DELETE_ALL_RENDER           (WM_USER + 0x106)
