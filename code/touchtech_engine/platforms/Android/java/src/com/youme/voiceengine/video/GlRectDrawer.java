...
public class GlRectDrawer implements RendererCommon.GlDrawer {
    ...
    private FloatBuffer rectangle_tex_buf = GlUtil.createFloatBuffer(new float[] {
            0.0f, 0.0f, // Bottom left.
            1.0f, 0.0f, // Bottom right.
            0.0f, 1.0f, // Top left.
            1.0f, 1.0f // Top right.
    ...
    private void prepareShader(String fragmentShader, float[] texMatrix) {
        ...
        if (shaders.containsKey(fragmentShader)) {
        	...
        	if(drawPositionNew != drawPosition)
        	{
        		drawPosition = drawPositionNew;
        		rectangle_tex_buf.clear();
        		rectangle_tex_buf = null;
        	    if(1 == drawPosition){
            		rectangle_tex_buf = GlUtil.createFloatBuffer(new float[] {
            	            0.0f, 0.0f, // Bottom left.
            ...
            shader.glShader.setVertexAttribArray("in_tc", 2, rectangle_tex_buf);
        	}catch(Exception e){
        		e.printStackTrace();
        		return;
        	}
