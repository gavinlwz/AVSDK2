...
public class Camera2Enumerator implements CameraEnumerator {
    ...
    private static final Map<String, List<CameraEnumerationAndroid.CaptureFormat>> cachedSupportedFormats =
            new HashMap<String, List<CameraEnumerationAndroid.CaptureFormat>>();
    ...
    static List<CameraEnumerationAndroid.CaptureFormat> getSupportedFormats(CameraManager cameraManager, String cameraId) {
        synchronized (cachedSupportedFormats) {
            ...
            for (Size size : sizes) {
                ...
                Log.d(TAG, "Format: " + size.width + "x" + size.height + "@" + maxFps);
            }
    ...
    static List<CameraEnumerationAndroid.CaptureFormat.FramerateRange> convertFramerates(
