...
public abstract class EglBase {
  ...
  public static Context createContext(Object sharedContext) {
	  if(sharedContext == null)
		  return null;
	  if(EglBase14.isEGL14Supported()){
		  return new EglBase14.Context((android.opengl.EGLContext)sharedContext);
	  }
	  else{
		  return new EglBase10.Context((javax.microedition.khronos.egl.EGLContext)sharedContext);
	  }
		            
  }
  
  public static Object eglGetCurrentContext()
  {
	  Context obj = null;
	  return obj;
