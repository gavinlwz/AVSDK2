...
public class api {
     ...
     */
    public int init(String strAPPKey, String strAPPSecret, int serverRegionId, String strExtServerRegionName) {
        int ret = NativeEngine.init(strAPPKey, strAPPSecret, serverRegionId, strExtServerRegionName);
        return ret;
    }
    ...
    public void setUserLogPath(String filePath) {
        NativeEngine.setUserLogPath(filePath);
    }
     ...
     * @return 无
     */
    public void setSpeakerMute(boolean bOn) {
     ...
     * 其他 - 具体错误码
     */
    public int switchResolutionForLandscape() {
        return NativeEngine.switchResolutionForLandscape();
    }
     ...
     * 其他 - 具体错误码
     */
    public void setlocalVideoPreviewMirror(boolean enable) {
