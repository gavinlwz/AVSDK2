...
#ifndef WEBRTC_MODULES_AUDIO_PROCESSING_UTILITY_DELAY_ESTIMATOR_NEW_H_
#define WEBRTC_MODULES_AUDIO_PROCESSING_UTILITY_DELAY_ESTIMATOR_NEW_H_
...
typedef struct {
  ...
  BinaryDelayEstimatorFarend* media_end;

  int16_t* sDelay_accum;
  int16_t* sDelay_VadR;
  int16_t sCand_delay_Save;
  int16_t sValley_depthMax;
  int16_t sDelay_Start_valley_depth;
  int16_t sDelay_valley_depth_th;
  int16_t sNew_Candidate_Delay;
  int32_t matrix_mean_bit[250];

  int16_t* sDelay_accum_media;
  int16_t* sDelay_VadMedia;
  int16_t sCand_delay_Save_media;
  int16_t sValley_depthMax_media;
  int16_t sDelay_Start_valley_depth_media;
  int16_t sDelay_valley_depth_th_media;
  int16_t sNew_Candidate_Delay_media;
  int32_t matrix_mean_bit_media[250];
  int last_delay_media;
...
#endif  // WEBRTC_MODULES_AUDIO_PROCESSING_UTILITY_DELAY_ESTIMATOR_NEW_H_
