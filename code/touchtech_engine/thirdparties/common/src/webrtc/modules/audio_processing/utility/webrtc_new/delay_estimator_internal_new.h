...
#ifndef WEBRTC_MODULES_AUDIO_PROCESSING_UTILITY_DELAY_ESTIMATOR_INTERNAL_NEW_H_
#define WEBRTC_MODULES_AUDIO_PROCESSING_UTILITY_DELAY_ESTIMATOR_INTERNAL_NEW_H_
...
namespace webrtc_new {
    ...
    typedef struct {
        ...
        int _playoutDelay;
        uint64_t playoutDelayMeasurementCounter;
    } DelayEstimator;
    }// namespace webrtc_new
}// namespace youme
#endif  // WEBRTC_MODULES_AUDIO_PROCESSING_UTILITY_DELAY_ESTIMATOR_INTERNAL_NEW_H_
