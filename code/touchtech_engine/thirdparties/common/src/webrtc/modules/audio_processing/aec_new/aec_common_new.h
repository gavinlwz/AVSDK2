...
#ifndef WEBRTC_MODULES_AUDIO_PROCESSING_AEC_AEC_COMMON_NEW_H_
#define WEBRTC_MODULES_AUDIO_PROCESSING_AEC_AEC_COMMON_NEW_H_
...
#endif  // WEBRTC_MODULES_AUDIO_PROCESSING_AEC_AEC_COMMON_NEW_H_
