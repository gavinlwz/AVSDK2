...
#else
static const int16_t WebRtcNsx_kLogTable[9] = { 0, 177, 355, 532, 710, 887, 1065, 1242, 1420 };

static const int16_t WebRtcNsx_kCounterDiv[201] = { 32767, 16384, 10923, 8192, 6554, 5461, 4681, 4096, 3641, 3277, 2979, 2731, 2521, 2341, 2185, 2048, 1928, 1820, 1725, 1638, 1560, 1489, 1425,
                                                    1365,  1311,  1260,  1214, 1170, 1130, 1092, 1057, 1024, 993,  964,  936,  910,  886,  862,  840,  819,  799,  780,  762,  745,  728,  712,
                                                    697,   683,   669,   655,  643,  630,  618,  607,  596,  585,  575,  565,  555,  546,  537,  529,  520,  512,  504,  496,  489,  482,  475,
                                                    468,   462,   455,   449,  443,  437,  431,  426,  420,  415,  410,  405,  400,  395,  390,  386,  381,  377,  372,  368,  364,  360,  356,
                                                    352,   349,   345,   341,  338,  334,  331,  328,  324,  321,  318,  315,  312,  309,  306,  303,  301,  298,  295,  293,  290,  287,  285,
                                                    282,   280,   278,   275,  273,  271,  269,  266,  264,  262,  260,  258,  256,  254,  252,  250,  248,  246,  245,  243,  241,  239,  237,
                                                    236,   234,   232,   231,  229,  228,  226,  224,  223,  221,  220,  218,  217,  216,  214,  213,  211,  210,  209,  207,  206,  205,  204,
                                                    202,   201,   200,   199,  197,  196,  195,  194,  193,  192,  191,  189,  188,  187,  186,  185,  184,  183,  182,  181,  180,  179,  178,
                                                    177,   176,   175,   174,  173,  172,  172,  171,  170,  169,  168,  167,  166,  165,  165,  164,  163 };

static const int16_t WebRtcNsx_kLogTableFrac[256] = { 0,   1,   3,   4,   6,   7,   9,   10,  11,  13,  14,  16,  17,  18,  20,  21,  22,  24,  25,  26,  28,  29,  30,  32,  33,  34,  36,  37,  38,
                                                      40,  41,  42,  44,  45,  46,  47,  49,  50,  51,  52,  54,  55,  56,  57,  59,  60,  61,  62,  63,  65,  66,  67,  68,  69,  71,  72,  73,  74,
                                                      75,  77,  78,  79,  80,  81,  82,  84,  85,  86,  87,  88,  89,  90,  92,  93,  94,  95,  96,  97,  98,  99,  100, 102, 103, 104, 105, 106, 107,
                                                      108, 109, 110, 111, 112, 113, 114, 116, 117, 118, 119, 120, 121, 122, 123, 124, 125, 126, 127, 128, 129, 130, 131, 132, 133, 134, 135, 136, 137,
                                                      138, 139, 140, 141, 142, 143, 144, 145, 146, 147, 148, 149, 150, 151, 152, 153, 154, 155, 155, 156, 157, 158, 159, 160, 161, 162, 163, 164, 165,
                                                      166, 167, 168, 169, 169, 170, 171, 172, 173, 174, 175, 176, 177, 178, 178, 179, 180, 181, 182, 183, 184, 185, 185, 186, 187, 188, 189, 190, 191,
                                                      192, 192, 193, 194, 195, 196, 197, 198, 198, 199, 200, 201, 202, 203, 203, 204, 205, 206, 207, 208, 208, 209, 210, 211, 212, 212, 213, 214, 215,
                                                      216, 216, 217, 218, 219, 220, 220, 221, 222, 223, 224, 224, 225, 226, 227, 228, 228, 229, 230, 231, 231, 232, 233, 234, 234, 235, 236, 237, 238,
                                                      238, 239, 240, 241, 241, 242, 243, 244, 244, 245, 246, 247, 247, 248, 249, 249, 250, 251, 252, 252, 253, 254, 255, 255 };
...
static const int16_t kBlocks80w128x[128] = { 0,     536,   1072,  1606,  2139,  2669,  3196,  3720,  4240,  4756,  5266,  5771,  6270,  6762,  7246,  7723,  8192,  8652,  9102,  9543,  9974,  10394,
                                             10803, 11200, 11585, 11958, 12318, 12665, 12998, 13318, 13623, 13913, 14189, 14449, 14694, 14924, 15137, 15334, 15515, 15679, 15826, 15956, 16069, 16165,
                                             16244, 16305, 16349, 16375, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384,
                                             16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16375, 16349, 16305, 16244, 16165, 16069, 15956,
                                             15826, 15679, 15515, 15334, 15137, 14924, 14694, 14449, 14189, 13913, 13623, 13318, 12998, 12665, 12318, 11958, 11585, 11200, 10803, 10394, 9974,  9543,
                                             9102,  8652,  8192,  7723,  7246,  6762,  6270,  5771,  5266,  4756,  4240,  3720,  3196,  2669,  2139,  1606,  1072,  536 };

// hybrib Hanning & flat window
static const int16_t kBlocks160w256x[256] = { 0,     268,   536,   804,   1072,  1339,  1606,  1872,  2139,  2404,  2669,  2933,  3196,  3459,  3720,  3981,  4240,  4499,  4756,  5012,  5266,  5520,
                                              5771,  6021,  6270,  6517,  6762,  7005,  7246,  7486,  7723,  7959,  8192,  8423,  8652,  8878,  9102,  9324,  9543,  9760,  9974,  10185, 10394, 10600,
                                              10803, 11003, 11200, 11394, 11585, 11773, 11958, 12140, 12318, 12493, 12665, 12833, 12998, 13160, 13318, 13472, 13623, 13770, 13913, 14053, 14189, 14321,
                                              14449, 14574, 14694, 14811, 14924, 15032, 15137, 15237, 15334, 15426, 15515, 15599, 15679, 15754, 15826, 15893, 15956, 16015, 16069, 16119, 16165, 16207,
                                              16244, 16277, 16305, 16329, 16349, 16364, 16375, 16382, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384,
                                              16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384,
                                              16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384, 16384,
                                              16384, 16384, 16384, 16384, 16384, 16384, 16384, 16382, 16375, 16364, 16349, 16329, 16305, 16277, 16244, 16207, 16165, 16119, 16069, 16015, 15956, 15893,
                                              15826, 15754, 15679, 15599, 15515, 15426, 15334, 15237, 15137, 15032, 14924, 14811, 14694, 14574, 14449, 14321, 14189, 14053, 13913, 13770, 13623, 13472,
                                              13318, 13160, 12998, 12833, 12665, 12493, 12318, 12140, 11958, 11773, 11585, 11394, 11200, 11003, 10803, 10600, 10394, 10185, 9974,  9760,  9543,  9324,
                                              9102,  8878,  8652,  8423,  8192,  7959,  7723,  7486,  7246,  7005,  6762,  6517,  6270,  6021,  5771,  5520,  5266,  5012,  4756,  4499,  4240,  3981,
                                              3720,  3459,  3196,  2933,  2669,  2404,  2139,  1872,  1606,  1339,  1072,  804,   536,   268 };
...
//    factor1 = 1.0;
//  }
static const int16_t kFactor1Table[257] = { 8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,
                                            8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,
                                            8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8192,  8233,
                                            8274,  8315,  8355,  8396,  8436,  8475,  8515,  8554,  8592,  8631,  8669,  8707,  8745,  8783,  8820,  8857,  8894,  8931,  8967,  9003,  9039,  9075,
                                            9111,  9146,  9181,  9216,  9251,  9286,  9320,  9354,  9388,  9422,  9456,  9489,  9523,  9556,  9589,  9622,  9655,  9687,  9719,  9752,  9784,  9816,
                                            9848,  9879,  9911,  9942,  9973,  10004, 10035, 10066, 10097, 10128, 10158, 10188, 10218, 10249, 10279, 10308, 10338, 10368, 10397, 10426, 10456, 10485,
                                            10514, 10543, 10572, 10600, 10629, 10657, 10686, 10714, 10742, 10770, 10798, 10826, 10854, 10882, 10847, 10810, 10774, 10737, 10701, 10666, 10631, 10596,
                                            10562, 10527, 10494, 10460, 10427, 10394, 10362, 10329, 10297, 10266, 10235, 10203, 10173, 10142, 10112, 10082, 10052, 10023, 9994,  9965,  9936,  9908,
                                            9879,  9851,  9824,  9796,  9769,  9742,  9715,  9689,  9662,  9636,  9610,  9584,  9559,  9534,  9508,  9484,  9459,  9434,  9410,  9386,  9362,  9338,
                                            9314,  9291,  9268,  9245,  9222,  9199,  9176,  9154,  9132,  9110,  9088,  9066,  9044,  9023,  9002,  8980,  8959,  8939,  8918,  8897,  8877,  8857,
                                            8836,  8816,  8796,  8777,  8757,  8738,  8718,  8699,  8680,  8661,  8642,  8623,  8605,  8586,  8568,  8550,  8532,  8514,  8496,  8478,  8460,  8443,
                                            8425,  8408,  8391,  8373,  8356,  8339,  8323,  8306,  8289,  8273,  8256,  8240,  8224,  8208,  8192 };
...
static const int16_t kFactor2Aggressiveness1[257] = { 7577, 7577, 7577, 7577, 7577, 7577, 7577, 7577, 7577, 7577, 7577, 7577, 7577, 7577, 7577, 7577, 7577, 7596, 7614, 7632, 7650, 7667, 7683, 7699,
                                                      7715, 7731, 7746, 7761, 7775, 7790, 7804, 7818, 7832, 7845, 7858, 7871, 7884, 7897, 7910, 7922, 7934, 7946, 7958, 7970, 7982, 7993, 8004, 8016,
                                                      8027, 8038, 8049, 8060, 8070, 8081, 8091, 8102, 8112, 8122, 8132, 8143, 8152, 8162, 8172, 8182, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192,
...
// Gain factor table: Input value in Q8 and output value in Q13
static const int16_t kFactor2Aggressiveness2[257] = { 7270, 7270, 7270, 7270, 7270, 7306, 7339, 7369, 7397, 7424, 7448, 7472, 7495, 7517, 7537, 7558, 7577, 7596, 7614, 7632, 7650, 7667, 7683, 7699,
                                                      7715, 7731, 7746, 7761, 7775, 7790, 7804, 7818, 7832, 7845, 7858, 7871, 7884, 7897, 7910, 7922, 7934, 7946, 7958, 7970, 7982, 7993, 8004, 8016,
                                                      8027, 8038, 8049, 8060, 8070, 8081, 8091, 8102, 8112, 8122, 8132, 8143, 8152, 8162, 8172, 8182, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192,
                                                      8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192,
                                                      8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192,
...
// Gain factor table: Input value in Q8 and output value in Q13
static const int16_t kFactor2Aggressiveness3[257] = { 7184, 7184, 7184, 7229, 7270, 7306, 7339, 7369, 7397, 7424, 7448, 7472, 7495, 7517, 7537, 7558, 7577, 7596, 7614, 7632, 7650, 7667, 7683, 7699,
                                                      7715, 7731, 7746, 7761, 7775, 7790, 7804, 7818, 7832, 7845, 7858, 7871, 7884, 7897, 7910, 7922, 7934, 7946, 7958, 7970, 7982, 7993, 8004, 8016,
                                                      8027, 8038, 8049, 8060, 8070, 8081, 8091, 8102, 8112, 8122, 8132, 8143, 8152, 8162, 8172, 8182, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192,
                                                      8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192,
                                                      8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192,
...
static const int16_t kSumLogIndex[66] = { 0,     22917, 22917, 22885, 22834, 22770, 22696, 22613, 22524, 22428, 22326, 22220, 22109, 21994, 21876, 21754, 21629, 21501, 21370, 21237, 21101, 20963,
                                          20822, 20679, 20535, 20388, 20239, 20089, 19937, 19783, 19628, 19470, 19312, 19152, 18991, 18828, 18664, 18498, 18331, 18164, 17994, 17824, 17653, 17480,
                                          17306, 17132, 16956, 16779, 16602, 16423, 16243, 16063, 15881, 15699, 15515, 15331, 15146, 14960, 14774, 14586, 14398, 14209, 14019, 13829, 13637, 13445 };

// sum of log2(i)^2 from table index to inst->anaLen2 in Q2
// Note that the first table value is invalid, since log2(0) = -infinity
static const int16_t kSumSquareLogIndex[66] = { 0,     16959, 16959, 16955, 16945, 16929, 16908, 16881, 16850, 16814, 16773, 16729, 16681, 16630, 16575, 16517, 16456,
                                                16392, 16325, 16256, 16184, 16109, 16032, 15952, 15870, 15786, 15700, 15612, 15521, 15429, 15334, 15238, 15140, 15040,
                                                14938, 14834, 14729, 14622, 14514, 14404, 14292, 14179, 14064, 13947, 13830, 13710, 13590, 13468, 13344, 13220, 13094,
                                                12966, 12837, 12707, 12576, 12444, 12310, 12175, 12039, 11902, 11763, 11624, 11483, 11341, 11198, 11054 };

// log2(table index) in Q12
// Note that the first table value is invalid, since log2(0) = -infinity
static const int16_t kLogIndex[129] = { 0,     0,     4096,  6492,  8192,  9511,  10588, 11499, 12288, 12984, 13607, 14170, 14684, 15157, 15595, 16003, 16384, 16742, 17080, 17400, 17703, 17991,
                                        18266, 18529, 18780, 19021, 19253, 19476, 19691, 19898, 20099, 20292, 20480, 20662, 20838, 21010, 21176, 21338, 21496, 21649, 21799, 21945, 22087, 22226,
                                        22362, 22495, 22625, 22752, 22876, 22998, 23117, 23234, 23349, 23462, 23572, 23680, 23787, 23892, 23994, 24095, 24195, 24292, 24388, 24483, 24576, 24668,
                                        24758, 24847, 24934, 25021, 25106, 25189, 25272, 25354, 25434, 25513, 25592, 25669, 25745, 25820, 25895, 25968, 26041, 26112, 26183, 26253, 26322, 26390,
                                        26458, 26525, 26591, 26656, 26721, 26784, 26848, 26910, 26972, 27033, 27094, 27154, 27213, 27272, 27330, 27388, 27445, 27502, 27558, 27613, 27668, 27722,
                                        27776, 27830, 27883, 27935, 27988, 28039, 28090, 28141, 28191, 28241, 28291, 28340, 28388, 28437, 28484, 28532, 28579, 28626, 28672 };

// determinant of estimation matrix in Q0 corresponding to the log2 tables above
// Note that the first table value is invalid, since log2(0) = -infinity
static const int16_t kDeterminantEstMatrix[66] = { 0,    29814, 25574, 22640, 20351, 18469, 16873, 15491, 14277, 13199, 12233, 11362, 10571, 9851, 9192, 8587, 8030, 7515, 7038, 6596, 6186, 5804,
                                                   5448, 5115,  4805,  4514,  4242,  3988,  3749,  3524,  3314,  3116,  2930,  2755,  2590,  2435, 2289, 2152, 2022, 1900, 1785, 1677, 1575, 1478,
                                                   1388, 1302,  1221,  1145,  1073,  1005,  942,   881,   825,   771,   721,   674,   629,   587,  547,  510,  475,  442,  411,  382,  355,  330 };
...
static void UpdateNoiseEstimate (NoiseSuppressionFixedC *inst, int offset)
{
    ...
    tmp16 = YoumeWebRtcSpl_MaxValueW16 (inst->noiseEstLogQuantile + offset, inst->magnLen);
    // Guarantee a Q-domain as high as possible and still fit in int16
    inst->qNoise = 14 - (int)WEBRTC_SPL_MUL_16_16_RSFT_WITH_ROUND (kExp2Const, tmp16, 21);
    for (i = 0; i < inst->magnLen; i++)
    {
        ...
        inst->noiseEstQuantile[i] = YoumeWebRtcSpl_SatW32ToW16 (tmp32no1);
    }
}

// Noise Estimation
static void NoiseEstimationC (NoiseSuppressionFixedC *inst, uint16_t *magn, uint32_t *noise, int16_t *q_noise)
{
    ...
    for (i = 0; i < inst->magnLen; i++)
    {
        if (magn[i])
        {
            zeros = YoumeWebRtcSpl_NormU32 ((uint32_t)magn[i]);
    ...
    for (s = 0; s < SIMULT; s++)
    {
        ...
        for (i = 0; i < inst->magnLen; i++)
        {
            ...
            if (inst->noiseEstDensity[offset + i] > 512)
            {
                ...
                int factor = YoumeWebRtcSpl_NormW16 (inst->noiseEstDensity[offset + i]);
            ...
            if (WEBRTC_SPL_ABS_W16 (lmagn[i] - inst->noiseEstLogQuantile[offset + i]) < WIDTH_Q8)
            {
                tmp16no1 = (int16_t)WEBRTC_SPL_MUL_16_16_RSFT_WITH_ROUND (inst->noiseEstDensity[offset + i], countProd, 15);
                tmp16no2 = (int16_t)WEBRTC_SPL_MUL_16_16_RSFT_WITH_ROUND (width_factor, countDiv, 15);
...
static void PrepareSpectrumC (NoiseSuppressionFixedC *inst, int16_t *freq_buf)
{
    ...
    for (i = 0; i < inst->magnLen; i++)
    {
        inst->real[i] = (int16_t)((inst->real[i] * (int16_t)(inst->noiseSupFilter[i])) >> 14); // Q(normData-stages)
        inst->imag[i] = (int16_t)((inst->imag[i] * (int16_t)(inst->noiseSupFilter[i])) >> 14); // Q(normData-stages)
    }
...
static void DenormalizeC (NoiseSuppressionFixedC *inst, int16_t *in, int factor)
{
    size_t i = 0;
    int32_t tmp32 = 0;
    for (i = 0; i < inst->anaLen; i += 1)
    {
        ...
        inst->real[i] = YoumeWebRtcSpl_SatW32ToW16 (tmp32); // Q0
    }
}

// For the noise supression process, synthesis, read out fully processed
// segment, and update synthesis buffer.
static void SynthesisUpdateC (NoiseSuppressionFixedC *inst, int16_t *out_frame, int16_t gain_factor)
{
    size_t i = 0;
    int16_t tmp16a = 0;
    int16_t tmp16b = 0;
    ...
    {
        tmp16a = (int16_t)WEBRTC_SPL_MUL_16_16_RSFT_WITH_ROUND (inst->window[i], inst->real[i], 14); // Q0, window in Q14
        tmp32 = WEBRTC_SPL_MUL_16_16_RSFT_WITH_ROUND (tmp16a, gain_factor, 13);                      // Q0
        // Down shift with rounding
        tmp16b = YoumeWebRtcSpl_SatW32ToW16 (tmp32);                                            // Q0
        inst->synthesisBuffer[i] = YoumeWebRtcSpl_AddSatW16 (inst->synthesisBuffer[i], tmp16b); // Q0
    }
    ...
    memcpy (inst->synthesisBuffer, inst->synthesisBuffer + inst->blockLen10ms, (inst->anaLen - inst->blockLen10ms) * sizeof (*inst->synthesisBuffer));
    YoumeWebRtcSpl_ZerosArrayW16 (inst->synthesisBuffer + inst->anaLen - inst->blockLen10ms, inst->blockLen10ms);
}

// Update analysis buffer for lower band, and window data before FFT.
static void AnalysisUpdateC (NoiseSuppressionFixedC *inst, int16_t *out, int16_t *new_speech)
{
    size_t i = 0;

    // For lower band update analysis buffer.
    memcpy (inst->analysisBuffer, inst->analysisBuffer + inst->blockLen10ms, (inst->anaLen - inst->blockLen10ms) * sizeof (*inst->analysisBuffer));
    memcpy (inst->analysisBuffer + inst->anaLen - inst->blockLen10ms, new_speech, inst->blockLen10ms * sizeof (*inst->analysisBuffer));

    // Window data before FFT.
    for (i = 0; i < inst->anaLen; i++)
    {
        out[i] = (int16_t)WEBRTC_SPL_MUL_16_16_RSFT_WITH_ROUND (inst->window[i], inst->analysisBuffer[i], 14); // Q0
    }
}

// Normalize the real-valued signal |in|, the input to forward FFT.
static void NormalizeRealBufferC (NoiseSuppressionFixedC *inst, const int16_t *in, int16_t *out)
{
    size_t i = 0;
...
int32_t WebRtcNsx_InitCore (NoiseSuppressionFixedC *inst, uint32_t fs)
{
    ...
    {
        YoumeWebRtcSpl_FreeRealFFT (inst->real_fft);
    }
    inst->real_fft = YoumeWebRtcSpl_CreateRealFFT (inst->stages);
    if (inst->real_fft == NULL)
    {
        return -1;
    }

    YoumeWebRtcSpl_ZerosArrayW16 (inst->analysisBuffer, ANAL_BLOCKL_MAX);
    YoumeWebRtcSpl_ZerosArrayW16 (inst->synthesisBuffer, ANAL_BLOCKL_MAX);

    // for HB processing
    YoumeWebRtcSpl_ZerosArrayW16 (inst->dataBufHBFX[0], NUM_HIGH_BANDS_MAX * ANAL_BLOCKL_MAX);
    // for quantile noise estimation
    YoumeWebRtcSpl_ZerosArrayW16 (inst->noiseEstQuantile, HALF_ANAL_BLOCKL);
    ...
    YoumeWebRtcSpl_MemSetW16 ((int16_t *)inst->noiseSupFilter, 16384, HALF_ANAL_BLOCKL);
    ...
    YoumeWebRtcSpl_ZerosArrayW16 (inst->histLrt, HIST_PAR_EST);
    YoumeWebRtcSpl_ZerosArrayW16 (inst->histSpecDiff, HIST_PAR_EST);
    YoumeWebRtcSpl_ZerosArrayW16 (inst->histSpecFlat, HIST_PAR_EST);
...
void WebRtcNsx_FeatureParameterExtraction (NoiseSuppressionFixedC *inst, int flag)
{
    ...
    if (!flag)
    {
        ...
        if (inst->timeAvgMagnEnergy > 0)
        {
            ...
            histIndex = ((inst->featureSpecDiff * 5) >> inst->stages) / inst->timeAvgMagnEnergy;
        }
        if (histIndex < HIST_PAR_EST)
        {
    ...
    if (flag)
    {
        ...
        fluctLrtFX = avgSquareHistLrtFX * numHistLrt - avgHistLrtFX * avgHistLrtComplFX;
        thresFluctLrtFX = THRES_FLUCT_LRT * numHistLrt;
        // get threshold for LRT feature:
        tmpU32 = (FACTOR_1_LRT_DIFF * (uint32_t)avgHistLrtFX);
        if ((fluctLrtFX < thresFluctLrtFX) || (numHistLrt == 0) || (tmpU32 > (uint32_t)(100 * numHistLrt)))
        {
        ...
        if (weightPeak1SpecFlat < THRES_WEIGHT_FLAT_DIFF || posPeak1SpecFlatFX < THRES_PEAK_FLAT)
        {
        ...
        { // if selected, get the threshold
            ...
            inst->thresholdSpecFlat = WEBRTC_SPL_SAT (MAX_FLAT_Q10, FACTOR_2_FLAT_Q10 * posPeak1SpecFlatFX, MIN_FLAT_Q10); // Q10
        }
        ...
        if (useFeatureSpecDiff)
        {
            ...
            inst->thresholdSpecDiff = WEBRTC_SPL_SAT (MAX_DIFF, FACTOR_1_LRT_DIFF * posPeak1SpecDiffFX, MIN_DIFF); // 5x bigger
...
void WebRtcNsx_ComputeSpectralFlatness (NoiseSuppressionFixedC *inst, uint16_t *magn)
{
    ...
    for (i = 1; i < inst->magnLen; i++)
    {
        ...
        {
            zeros = YoumeWebRtcSpl_NormU32 ((uint32_t)magn[i]);
            frac = (int16_t)(((uint32_t)((uint32_t)(magn[i]) << zeros) & 0x7FFFFFFF) >> 23);
            // log2(magn(i))
            assert (frac < 256);
            tmpU32 = (uint32_t)(((31 - zeros) << 8) + WebRtcNsx_kLogTableFrac[frac]); // Q8
    ...
    zeros = YoumeWebRtcSpl_NormU32 (avgSpectralFlatnessDen);
    ...
    tmp32 = (int32_t)(0x00020000 | (WEBRTC_SPL_ABS_W32 (logCurSpectralFlatness) & 0x0001FFFF)); // Q17
...
void WebRtcNsx_ComputeSpectralDifference (NoiseSuppressionFixedC *inst, uint16_t *magnIn)
{
    ...
    nShifts = WEBRTC_SPL_MAX (0, 10 + inst->stages - YoumeWebRtcSpl_NormW32 (tmp32no1));
    ...
    inst->curAvgMagnEnergy += inst->magnEnergy >> (2 * inst->normData + inst->stages - 1);
    ...
    if ((varPauseUFX) && (covMagnPauseFX))
    {
        ...
        norm32 = YoumeWebRtcSpl_NormU32 (tmpU32no1) - 16;
        if (norm32 > 0)
        {
    ...
    {
        tmpU32no2 = WEBRTC_SPL_UMUL_32_16 (inst->featureSpecDiff - tmpU32no1, SPECT_DIFF_TAVG_Q8); // Q(8-2*stages)
        inst->featureSpecDiff -= tmpU32no2 >> 8;                                                   // Q(-2*stages)
    }
    else
    {
        tmpU32no2 = WEBRTC_SPL_UMUL_32_16 (tmpU32no1 - inst->featureSpecDiff, SPECT_DIFF_TAVG_Q8); // Q(8-2*stages)
        inst->featureSpecDiff += tmpU32no2 >> 8;                                                   // Q(-2*stages)
    }
}
...
void WebRtcNsx_DataAnalysis (NoiseSuppressionFixedC *inst, short *speechFrame, uint16_t *magnU16)
{
    ...
    // Get input energy
    inst->energyIn = YoumeWebRtcSpl_Energy (winData, inst->anaLen, &inst->scaleEnergyIn);

    // Reset zero input flag
    inst->zeroInputSignal = 0;
    // Acquire norm for winData
    maxWinData = YoumeWebRtcSpl_MaxAbsValueW16 (winData, inst->anaLen);
    inst->normData = YoumeWebRtcSpl_NormW16 (maxWinData);
    if (maxWinData == 0)
    {
    ...
    YoumeWebRtcSpl_RealForwardFFT (inst->real_fft, realImag, winData);
    ...
    inst->magnEnergy += (uint32_t)(inst->real[inst->anaLen2] * inst->real[inst->anaLen2]);
    ...
    if (inst->blockIndex >= END_STARTUP_SHORT)
    {
        for (i = 1, j = 2; i < inst->anaLen2; i += 1, j += 2)
        {
            ...
            magnU16[i] = (uint16_t)YoumeWebRtcSpl_SqrtFloor (tmpU32no1); // Q(normData-stages)
    ...
    else
    {
        ...
        inst->initMagnEst[inst->anaLen2] += magnU16[inst->anaLen2] >> right_shifts_in_magnU16;

        log2 = 0;
        if (magnU16[inst->anaLen2])
        {
            // Calculate log2(magnU16[inst->anaLen2])
            zeros = YoumeWebRtcSpl_NormU32 ((uint32_t)magnU16[inst->anaLen2]);
            frac = (int16_t)((((uint32_t)magnU16[inst->anaLen2] << zeros) & 0x7FFFFFFF) >> 23); // Q8
        ...
        for (i = 1, j = 2; i < inst->anaLen2; i += 1, j += 2)
        {
            ...
            if (i >= kStartBand)
            {
                ...
                if (magnU16[i])
                {
                    zeros = YoumeWebRtcSpl_NormU32 ((uint32_t)magnU16[i]);
                    frac = (int16_t)((((uint32_t)magnU16[i] << zeros) & 0x7FFFFFFF) >> 23);
                    // log2(magnU16(i)) in Q8
                    assert (frac < 256);
                    log2 = (int16_t)(((31 - zeros) << 8) + WebRtcNsx_kLogTableFrac[frac]);
                }
        ...
        zeros = 16 - YoumeWebRtcSpl_NormW32 (sum_log_magn);
        if (zeros < 0)
        {
            zeros = 0;
        }
        ...
        tmp_2_w32 = YoumeWebRtcSpl_DivW32W16 (tmp_2_w32, matrix_determinant);  // Q11
        ...
        if (tmp_2_w32 > 0)
        {
            ...
            // flat spectrum.
            tmp_1_w32 = YoumeWebRtcSpl_DivW32W16 (tmp_2_w32, matrix_determinant); // Q14
...
void WebRtcNsx_DataSynthesis (NoiseSuppressionFixedC *inst, short *outFrame)
{
    ...
    outCIFFT = YoumeWebRtcSpl_RealInverseFFT (inst->real_fft, realImag, rfft_out);

    WebRtcNsx_Denormalize (inst, rfft_out, outCIFFT);

    // scale factor: only do it after END_STARTUP_LONG time
    gainFactor = 8192; // 8192 = Q13(1.0)
    if (inst->gainMap == 1 && inst->blockIndex > END_STARTUP_LONG && inst->energyIn > 0)
    {
        // Q(-scaleEnergyOut)
        energyOut = YoumeWebRtcSpl_Energy (inst->real, inst->anaLen, &scaleEnergyOut);
        if (scaleEnergyOut == 0 && !(energyOut & 0x7f800000))
        {
            energyOut = WEBRTC_SPL_SHIFT_W32 (energyOut, 8 + scaleEnergyOut - inst->scaleEnergyIn);
        }
        else
        {
        ...
        tmp16no1 = (int16_t)(((16384 - inst->priorNonSpeechProb) * gainFactor1) >> 14); // in Q13, where 16384 = Q14(1.0)
...
void WebRtcNsx_ProcessCore (NoiseSuppressionFixedC *inst, const short* const* speechFrame, int num_bands, short* const* outFrame)
{
...
#ifdef NS_FILEDEBUG
    if (fwrite (spframe, sizeof (short), inst->blockLen10ms, inst->infile) != inst->blockLen10ms)
    {
        assert (false);
    }
#endif
    ...
    if (inst->zeroInputSignal)
    {
        ...
        if (num_bands > 1) {
            ...
            for (i = 0; i < num_high_bands; ++i) {
                ...
                memcpy(inst->dataBufHBFX[i], inst->dataBufHBFX[i] + inst->blockLen10ms, block_shift * sizeof(*inst->dataBufHBFX[i]));
                memcpy(inst->dataBufHBFX[i] + block_shift, speechFrameHB[i], inst->blockLen10ms * sizeof(*inst->dataBufHBFX[i]));
    ...
    if (inst->blockIndex < END_STARTUP_SHORT)
    {
        ...
        {
            pink_noise_exp_avg = (int16_t)YoumeWebRtcSpl_DivW32W16 (inst->pinkNoiseExp, (int16_t)(inst->blockIndex + 1)); // Q14
            pink_noise_num_avg = YoumeWebRtcSpl_DivW32W16 (inst->pinkNoiseNumerator, (int16_t)(inst->blockIndex + 1));    // Q11
            WebRtcNsx_CalcParametricNoiseEstimate (inst, pink_noise_exp_avg, pink_noise_num_avg, kStartBand, &noise_estimate, &noise_estimate_avg);
        }
        else
        {
        ...
        for (i = 0; i < inst->magnLen; i++)
        {
            ...
            if ((inst->pinkNoiseExp) && (i >= kStartBand))
            {
                ...
                WebRtcNsx_CalcParametricNoiseEstimate (inst, pink_noise_exp_avg, pink_noise_num_avg, i, &noise_estimate, &noise_estimate_avg);
            }
            ...
            if (inst->initMagnEst[i])
            {
                ...
                if (numerator > tmpU32no1)
                {
                    ...
                    // division
                    nShifts = YoumeWebRtcSpl_NormU32 (numerator);
                    ...
                    noiseSupFilterTmp[i] = (uint16_t)WEBRTC_SPL_SAT (16384, tmpU32no2, (uint32_t)(inst->denoiseBound)); // Q14
                }
            }
            ...
            tmpU32no2 = noise_estimate_avg >> (inst->minNorm - inst->stages - q_domain_to_use);
            ...
            noiseU32[i] = YoumeWebRtcSpl_DivU32U16 (tmpU32no1 + tmpU32no2, END_STARTUP_SHORT);
    ...
    if (inst->blockIndex < END_STARTUP_LONG)
    {
        ...
        inst->timeAvgMagnEnergyTmp += inst->magnEnergy >> (2 * inst->normData + inst->stages - 1);
        inst->timeAvgMagnEnergy = YoumeWebRtcSpl_DivU32U16 (inst->timeAvgMagnEnergyTmp, inst->blockIndex + 1);
    }
    ...
    if (flag)
    {
        ...
        if ((tmpU32no1 != inst->timeAvgMagnEnergy) && (inst->featureSpecDiff) && (inst->timeAvgMagnEnergy > 0))
        {
            norm32no1 = 0;
            tmpU32no3 = tmpU32no1;
            ...
            if (YoumeWebRtcSpl_NormU32 (tmpU32no3) < norm32no1)
            {
                inst->featureSpecDiff = 0x007FFFFF;
            }
            else
            {
                inst->featureSpecDiff = WEBRTC_SPL_MIN (0x007FFFFF, tmpU32no3 << norm32no1);
            }
        }
    ...
    norm32no1 = YoumeWebRtcSpl_NormU32 (maxNoiseU32);
    ...
    for (i = 0; i < inst->magnLen; i++)
    {
        ...
        if (tmpMagnU32 > tmpNoiseU32)
        {
            ...
            norm32no2 = WEBRTC_SPL_MIN (11, YoumeWebRtcSpl_NormU32 (tmpU32no1));
        ...
        if (inst->blockIndex < END_STARTUP_SHORT)
        {
            ...
            tmpU32no1 += tmpU32no2;
            inst->noiseSupFilter[i] = (uint16_t)YoumeWebRtcSpl_DivU32U16 (tmpU32no1, END_STARTUP_SHORT);
        }
    } // end of loop over frequencies
    // done with step3
    ...
    WebRtcNsx_DataSynthesis (inst, outFrame[0]);
#ifdef NS_FILEDEBUG
    if (fwrite (outframe, sizeof (short), inst->blockLen10ms, inst->outfile) != inst->blockLen10ms)
    {
        assert (false);
    }
#endif
    ...
    if (num_bands > 1) {
        ...
        for (i = 0; i < num_high_bands; ++i) {
            ...
            memcpy(inst->dataBufHBFX[i] + inst->anaLen - inst->blockLen10ms, speechFrameHB[i],
                   inst->blockLen10ms * sizeof(*inst->dataBufHBFX[i]));
        }
        // range for averaging low band quantities for H band gain
        
        gainTimeDomainHB = 16384; // 16384 = Q14(1.0)
        // average speech prob form low band
        // average filter gain from low band
        // ave over second half(i.e., 4->8kHz) of freq. spectrum
        tmpU32no1 = 0; // Q12
        tmpU16no1 = 0; // Q8
