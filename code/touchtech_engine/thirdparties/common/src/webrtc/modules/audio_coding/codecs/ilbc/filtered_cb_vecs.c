...
void WebRtcIlbcfix_FilteredCbVecs(
  ...
  YoumeWebRtcSpl_MemSetW16(CBmem+lMem, 0, CB_HALFFILTERLEN);
  YoumeWebRtcSpl_MemSetW16(CBmem-CB_HALFFILTERLEN, 0, CB_HALFFILTERLEN);
  YoumeWebRtcSpl_MemSetW16(cbvectors, 0, lMem-samples);
