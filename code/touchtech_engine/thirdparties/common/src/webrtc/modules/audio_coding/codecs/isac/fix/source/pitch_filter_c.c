...
void WebRtcIsacfix_PitchFilterCore(int loopNumber,
  ...
  for (i = 0; i < loopNumber; i++) {
    ...
    /* Low pass filter. */
    tmpW32 = 0;
    /* TODO(kma): Define a static inline function YoumeWebRtcSpl_DotProduct()
    ...
    outputBuf[*index2] = YoumeWebRtcSpl_SatW32ToW16(tmpW32);
    tmpW32 = inputBuf[*index2] + outputBuf[*index2];
    outputBuf2[*index2 + PITCH_BUFFSIZE] = YoumeWebRtcSpl_SatW32ToW16(tmpW32);
