...
#define WEBRTC_AEC_TO_PHONE_DEBUG

#ifdef WEBRTC_AEC_TO_PHONE_DEBUG
//#define WEBRTC_AEC_TO_PHONE_DEBUG_PCM
#define WEBRTC_AEC_TO_PHONE_DEBUG_NLP
#define WEBRTC_AEC_TO_PHONE_DEBUG_DELAY
// #define WEBRTC_AEC_TO_PHONE_DEBUG_DEVICE_DELAY
#define WEBRTC_AEC_NEW_CNG
#include <stdio.h>
#endif
