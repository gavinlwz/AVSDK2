...
void YoumeWebRtcSpl_DownBy2IntToShort(int32_t *in, int32_t len, int16_t *out,
                                 int32_t *state)
{
...
void YoumeWebRtcSpl_DownBy2ShortToInt(const int16_t *in,
                                  int32_t len,
                                  int32_t *out,
                                  int32_t *state)
{
...
// state:  filter state array; length = 8
void YoumeWebRtcSpl_UpBy2ShortToInt(const int16_t *in, int32_t len, int32_t *out,
                               int32_t *state)
{
    int32_t tmp0, tmp1, diff;
    int32_t i;
...
// output: int32_t (shifted 15 positions to the left, + offset 16384) (of length len*2)
// state:  filter state array; length = 8
void YoumeWebRtcSpl_UpBy2IntToInt(const int32_t *in, int32_t len, int32_t *out,
                             int32_t *state)
{
    int32_t tmp0, tmp1, diff;
    int32_t i;
...
// output: int16_t (saturated) (of length len*2)
// state:  filter state array; length = 8
void YoumeWebRtcSpl_UpBy2IntToShort(const int32_t *in, int32_t len, int16_t *out,
                               int32_t *state)
{
    int32_t tmp0, tmp1, diff;
    int32_t i;
...
// state:  filter state array; length = 8
void YoumeWebRtcSpl_LPBy2ShortToInt(const int16_t* in, int32_t len, int32_t* out,
                               int32_t* state)
{
    int32_t tmp0, tmp1, diff;
    int32_t i;
...
// output: int32_t (normalized, not saturated)
// state:  filter state array; length = 8
void YoumeWebRtcSpl_LPBy2IntToInt(const int32_t* in, int32_t len, int32_t* out,
                             int32_t* state)
{
    int32_t tmp0, tmp1, diff;
    int32_t i;
