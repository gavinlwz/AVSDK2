...
/*
 * This file contains the function YoumeWebRtcSpl_FilterAR().
...
size_t YoumeWebRtcSpl_FilterAR(const int16_t* a,
                          size_t a_length,
                          const int16_t* x,
                          size_t x_length,
                          int16_t* state,
                          ...
                          size_t filtered_low_length)
{
    ...
    {
        YoumeWebRtcSpl_CopyFromEndW16(filtered, x_length, a_length - 1, state);
        YoumeWebRtcSpl_CopyFromEndW16(filtered_low, x_length, a_length - 1, state_low);
    } else
    {
