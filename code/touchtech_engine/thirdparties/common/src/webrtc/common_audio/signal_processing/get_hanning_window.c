...
/*
 * This file contains the function YoumeWebRtcSpl_GetHanningWindow().
...
void YoumeWebRtcSpl_GetHanningWindow(int16_t *v, size_t size)
{
    size_t jj;
    int16_t *vptr1;
    ...
    factor = YoumeWebRtcSpl_DivW32W16(factor, (int16_t)size);
    if (size < 513)
