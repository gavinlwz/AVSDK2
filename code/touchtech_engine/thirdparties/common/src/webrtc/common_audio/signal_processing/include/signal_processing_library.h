...
int16_t YoumeWebRtcSpl_GetScalingSquare(int16_t* in_vector,
                                   size_t in_vector_length,
                                   size_t times);

// Copy and set operations. Implementation in copy_set_operations.c.
// Descriptions at bottom of file.
void YoumeWebRtcSpl_MemSetW16(int16_t* vector,
                         int16_t set_value,
                         size_t vector_length);
void YoumeWebRtcSpl_MemSetW32(int32_t* vector,
                         int32_t set_value,
                         size_t vector_length);
void YoumeWebRtcSpl_MemCpyReversedOrder(int16_t* out_vector,
                                   int16_t* in_vector,
                                   size_t vector_length);
void YoumeWebRtcSpl_CopyFromEndW16(const int16_t* in_vector,
                              size_t in_vector_length,
                              size_t samples,
                              int16_t* out_vector);
void YoumeWebRtcSpl_ZerosArrayW16(int16_t* vector,
                             size_t vector_length);
void YoumeWebRtcSpl_ZerosArrayW32(int32_t* vector,
                             size_t vector_length);
...
extern MaxAbsValueW16 YoumeWebRtcSpl_MaxAbsValueW16;
int16_t YoumeWebRtcSpl_MaxAbsValueW16C(const int16_t* vector, size_t length);
#if (defined WEBRTC_DETECT_NEON) || (defined WEBRTC_HAS_NEON)
int16_t YoumeWebRtcSpl_MaxAbsValueW16Neon(const int16_t* vector, size_t length);
#endif
#if defined(MIPS32_LE)
int16_t YoumeWebRtcSpl_MaxAbsValueW16_mips(const int16_t* vector, size_t length);
#endif
...
extern MaxAbsValueW32 YoumeWebRtcSpl_MaxAbsValueW32;
int32_t YoumeWebRtcSpl_MaxAbsValueW32C(const int32_t* vector, size_t length);
#if (defined WEBRTC_DETECT_NEON) || (defined WEBRTC_HAS_NEON)
int32_t YoumeWebRtcSpl_MaxAbsValueW32Neon(const int32_t* vector, size_t length);
#endif
#if defined(MIPS_DSP_R1_LE)
int32_t YoumeWebRtcSpl_MaxAbsValueW32_mips(const int32_t* vector, size_t length);
#endif
...
extern MaxValueW16 YoumeWebRtcSpl_MaxValueW16;
int16_t YoumeWebRtcSpl_MaxValueW16C(const int16_t* vector, size_t length);
#if (defined WEBRTC_DETECT_NEON) || (defined WEBRTC_HAS_NEON)
int16_t YoumeWebRtcSpl_MaxValueW16Neon(const int16_t* vector, size_t length);
#endif
#if defined(MIPS32_LE)
int16_t YoumeWebRtcSpl_MaxValueW16_mips(const int16_t* vector, size_t length);
#endif
...
extern MaxValueW32 YoumeWebRtcSpl_MaxValueW32;
int32_t YoumeWebRtcSpl_MaxValueW32C(const int32_t* vector, size_t length);
#if (defined WEBRTC_DETECT_NEON) || (defined WEBRTC_HAS_NEON)
int32_t YoumeWebRtcSpl_MaxValueW32Neon(const int32_t* vector, size_t length);
#endif
#if defined(MIPS32_LE)
int32_t YoumeWebRtcSpl_MaxValueW32_mips(const int32_t* vector, size_t length);
#endif
...
extern MinValueW16 YoumeWebRtcSpl_MinValueW16;
int16_t YoumeWebRtcSpl_MinValueW16C(const int16_t* vector, size_t length);
#if (defined WEBRTC_DETECT_NEON) || (defined WEBRTC_HAS_NEON)
int16_t YoumeWebRtcSpl_MinValueW16Neon(const int16_t* vector, size_t length);
#endif
#if defined(MIPS32_LE)
int16_t YoumeWebRtcSpl_MinValueW16_mips(const int16_t* vector, size_t length);
#endif
...
extern MinValueW32 YoumeWebRtcSpl_MinValueW32;
int32_t YoumeWebRtcSpl_MinValueW32C(const int32_t* vector, size_t length);
#if (defined WEBRTC_DETECT_NEON) || (defined WEBRTC_HAS_NEON)
int32_t YoumeWebRtcSpl_MinValueW32Neon(const int32_t* vector, size_t length);
#endif
#if defined(MIPS32_LE)
int32_t YoumeWebRtcSpl_MinValueW32_mips(const int32_t* vector, size_t length);
#endif
...
void YoumeWebRtcSpl_VectorBitShiftW16(int16_t* out_vector,
                                 size_t vector_length,
                                 const int16_t* in_vector,
                                 int16_t right_shifts);
void YoumeWebRtcSpl_VectorBitShiftW32(int32_t* out_vector,
                                 size_t vector_length,
                                 const int32_t* in_vector,
                                 int16_t right_shifts);
void YoumeWebRtcSpl_VectorBitShiftW32ToW16(int16_t* out_vector,
                                      size_t vector_length,
                                      const int32_t* in_vector,
                                      int right_shifts);
void YoumeWebRtcSpl_ScaleVector(const int16_t* in_vector,
                           int16_t* out_vector,
                           int16_t gain,
                           size_t vector_length,
                           int16_t right_shifts);
void YoumeWebRtcSpl_ScaleVectorWithSat(const int16_t* in_vector,
                                  int16_t* out_vector,
                                  int16_t gain,
                                  size_t vector_length,
                                  int16_t right_shifts);
void YoumeWebRtcSpl_ScaleAndAddVectors(const int16_t* in_vector1,
...
typedef int (*ScaleAndAddVectorsWithRound)(const int16_t* in_vector1,
                                           ...
                                           int16_t* out_vector,
                                           size_t length);
extern ScaleAndAddVectorsWithRound YoumeWebRtcSpl_ScaleAndAddVectorsWithRound;
int YoumeWebRtcSpl_ScaleAndAddVectorsWithRoundC(const int16_t* in_vector1,
                                           int16_t in_vector1_scale,
                                           const int16_t* in_vector2,
                                           int16_t in_vector2_scale,
                                           int right_shifts,
                                           ...
                                           size_t length);
#if defined(MIPS_DSP_R1_LE)
int YoumeWebRtcSpl_ScaleAndAddVectorsWithRound_mips(const int16_t* in_vector1,
                                               int16_t in_vector1_scale,
                                               const int16_t* in_vector2,
                                               int16_t in_vector2_scale,
                                               int right_shifts,
...
#endif
#if (defined WEBRTC_DETECT_NEON) || (defined WEBRTC_HAS_NEON)
int YoumeWebRtcSpl_ScaleAndAddVectorsWithRoundNeon(const int16_t* in_vector1,
                                                   int16_t in_vector1_scale,
                                                   const int16_t* in_vector2,
                                                   int16_t in_vector2_scale,
                                                   int right_shifts,
...
// Description at bottom of file.
void YoumeWebRtcSpl_ReverseOrderMultArrayElements(int16_t* out_vector,
                                             const int16_t* in_vector,
                                             const int16_t* window,
                                             size_t vector_length,
                                             int16_t right_shifts);
void YoumeWebRtcSpl_ElementwiseVectorMult(int16_t* out_vector,
                                     const int16_t* in_vector,
                                     const int16_t* window,
                                     size_t vector_length,
                                     int16_t right_shifts);
void YoumeWebRtcSpl_AddVectorsAndShift(int16_t* out_vector,
                                  const int16_t* in_vector1,
                                  const int16_t* in_vector2,
                                  size_t vector_length,
                                  int16_t right_shifts);
void YoumeWebRtcSpl_AddAffineVectorToVector(int16_t* out_vector,
                                       int16_t* in_vector,
                                       int16_t gain,
                                       int32_t add_constant,
                                       int16_t right_shifts,
                                       size_t vector_length);
void YoumeWebRtcSpl_AffineTransformVector(int16_t* out_vector,
                                     int16_t* in_vector,
                                     int16_t gain,
                                     int32_t add_constant,
                                     int16_t right_shifts,
...
size_t YoumeWebRtcSpl_AutoCorrelation(const int16_t* in_vector,
                                 size_t in_vector_length,
                                 size_t order,
                                 int32_t* result,
                                 int* scale);
...
int16_t YoumeWebRtcSpl_LevinsonDurbin(const int32_t* auto_corr,
                                 int16_t* lpc_coef,
                                 int16_t* refl_coef,
                                 size_t order);
...
void YoumeWebRtcSpl_ReflCoefToLpc(const int16_t* refl_coef,
                             int use_order,
                             int16_t* lpc_coef);
...
void YoumeWebRtcSpl_LpcToReflCoef(int16_t* lpc_coef,
                             int use_order,
                             int16_t* refl_coef);
...
// Output:
//      - refl_coef : Reflection coefficients in Q15.
void YoumeWebRtcSpl_AutoCorrToReflCoef(const int32_t* auto_corr,
                                  int use_order,
                                  int16_t* refl_coef);
...
typedef void (*CrossCorrelation)(int32_t* cross_correlation,
                                 ...
                                 int right_shifts,
                                 int step_seq2);
extern CrossCorrelation YoumeWebRtcSpl_CrossCorrelation;
void YoumeWebRtcSpl_CrossCorrelationC(int32_t* cross_correlation,
                                 const int16_t* seq1,
                                 const int16_t* seq2,
                                 size_t dim_seq,
                                 size_t dim_cross_correlation,
                                 ...
                                 int step_seq2);
#if (defined WEBRTC_DETECT_NEON) || (defined WEBRTC_HAS_NEON)
void YoumeWebRtcSpl_CrossCorrelationNeon(int32_t* cross_correlation,
                                    const int16_t* seq1,
                                    const int16_t* seq2,
                                    size_t dim_seq,
                                    size_t dim_cross_correlation,
...
#endif
#if defined(MIPS32_LE)
void YoumeWebRtcSpl_CrossCorrelation_mips(int32_t* cross_correlation,
                                     const int16_t* seq1,
                                     const int16_t* seq2,
                                     size_t dim_seq,
                                     size_t dim_cross_correlation,
...
void YoumeWebRtcSpl_GetHanningWindow(int16_t* window, size_t size);
...
void YoumeWebRtcSpl_SqrtOfOneMinusXSquared(int16_t* in_vector,
                                      size_t vector_length,
                                      int16_t* out_vector);
...
int16_t YoumeWebRtcSpl_RandU(uint32_t* seed);
int16_t YoumeWebRtcSpl_RandN(uint32_t* seed);
int16_t YoumeWebRtcSpl_RandUArray(int16_t* vector,
                             int16_t vector_length,
                             uint32_t* seed);
// End: Randomization functions.

// Math functions
int32_t YoumeWebRtcSpl_Sqrt(int32_t value);

int32_t YoumeWebRtcSpl_SqrtFloor(int32_t value);

// Divisions. Implementations collected in division_operations.c and
// descriptions at bottom of this file.
uint32_t YoumeWebRtcSpl_DivU32U16(uint32_t num, uint16_t den);
int32_t YoumeWebRtcSpl_DivW32W16(int32_t num, int16_t den);
int16_t YoumeWebRtcSpl_DivW32W16ResW16(int32_t num, int16_t den);
int32_t YoumeWebRtcSpl_DivResultInQ31(int32_t num, int32_t den);
int32_t YoumeWebRtcSpl_DivW32HiLow(int32_t num, int16_t den_hi, int16_t den_low);
// End: Divisions.

int32_t YoumeWebRtcSpl_Energy(int16_t* vector,
                         size_t vector_length,
                         int* scale_factor);
...
int32_t YoumeWebRtcSpl_DotProductWithScale(const int16_t* vector1,
                                      const int16_t* vector2,
                                      size_t length,
                                      int scaling);

// Filter operations.
size_t YoumeWebRtcSpl_FilterAR(const int16_t* ar_coef,
...
// YoumeWebRtcSpl_FilterMAFastQ12(...)
//
...
//
void YoumeWebRtcSpl_FilterMAFastQ12(const int16_t* in_vector,
                               int16_t* out_vector,
...
void YoumeWebRtcSpl_FilterARFastQ12(const int16_t* data_in,
                               int16_t* data_out,
...
typedef int (*DownsampleFast)(const int16_t* data_in,
                              ...
                              int factor,
                              size_t delay);
extern DownsampleFast YoumeWebRtcSpl_DownsampleFast;
int YoumeWebRtcSpl_DownsampleFastC(const int16_t* data_in,
                              size_t data_in_length,
                              int16_t* data_out,
                              size_t data_out_length,
                              const int16_t* __restrict coefficients,
                              ...
                              size_t delay);
#if (defined WEBRTC_DETECT_NEON) || (defined WEBRTC_HAS_NEON)
int YoumeWebRtcSpl_DownsampleFastNeon(const int16_t* data_in,
                                 size_t data_in_length,
                                 int16_t* data_out,
                                 size_t data_out_length,
                                 const int16_t* __restrict coefficients,
...
#endif
#if defined(MIPS32_LE)
int YoumeWebRtcSpl_DownsampleFast_mips(const int16_t* data_in,
                                  size_t data_in_length,
                                  int16_t* data_out,
                                  size_t data_out_length,
                                  const int16_t* __restrict coefficients,
...
int YoumeWebRtcSpl_ComplexFFT(int16_t vector[], int stages, int mode);
int YoumeWebRtcSpl_ComplexIFFT(int16_t vector[], int stages, int mode);
...
//                        10, since the table YoumeWebRtcSpl_kSinTable1024[] is 1024
//                        elements long.
//
// Output:
//      - complex_data  : The complex data buffer.

void YoumeWebRtcSpl_ComplexBitReverse(int16_t* __restrict complex_data, int stages);
...
typedef struct {
  ...
  int32_t S_44_32[8];
  int32_t S_32_16[8];
} YoumeWebRtcSpl_State22khzTo16khz;

void YoumeWebRtcSpl_Resample22khzTo16khz(const int16_t* in,
                                    int16_t* out,
                                    YoumeWebRtcSpl_State22khzTo16khz* state,
                                    int32_t* tmpmem);

void YoumeWebRtcSpl_ResetResample22khzTo16khz(YoumeWebRtcSpl_State22khzTo16khz* state);

// state structure for 16 -> 22 resampler
typedef struct {
  int32_t S_16_32[8];
  int32_t S_32_22[8];
} YoumeWebRtcSpl_State16khzTo22khz;

void YoumeWebRtcSpl_Resample16khzTo22khz(const int16_t* in,
                                    int16_t* out,
                                    YoumeWebRtcSpl_State16khzTo22khz* state,
                                    int32_t* tmpmem);

void YoumeWebRtcSpl_ResetResample16khzTo22khz(YoumeWebRtcSpl_State16khzTo22khz* state);
...
typedef struct {
  ...
  int32_t S_22_16[8];
  int32_t S_16_8[8];
} YoumeWebRtcSpl_State22khzTo8khz;

void YoumeWebRtcSpl_Resample22khzTo8khz(const int16_t* in, int16_t* out,
                                   YoumeWebRtcSpl_State22khzTo8khz* state,
                                   int32_t* tmpmem);

void YoumeWebRtcSpl_ResetResample22khzTo8khz(YoumeWebRtcSpl_State22khzTo8khz* state);
...
typedef struct {
  ...
  int32_t S_16_11[8];
  int32_t S_11_22[8];
} YoumeWebRtcSpl_State8khzTo22khz;

void YoumeWebRtcSpl_Resample8khzTo22khz(const int16_t* in, int16_t* out,
                                   YoumeWebRtcSpl_State8khzTo22khz* state,
                                   int32_t* tmpmem);

void YoumeWebRtcSpl_ResetResample8khzTo22khz(YoumeWebRtcSpl_State8khzTo22khz* state);
...
void YoumeWebRtcSpl_Resample48khzTo32khz(const int32_t* In, int32_t* Out, size_t K);

void YoumeWebRtcSpl_Resample32khzTo24khz(const int32_t* In, int32_t* Out, size_t K);

void YoumeWebRtcSpl_Resample44khzTo32khz(const int32_t* In, int32_t* Out, size_t K);
...
typedef struct {
  ...
  int32_t S_48_32[8];
  int32_t S_32_16[8];
} YoumeWebRtcSpl_State48khzTo16khz;

void YoumeWebRtcSpl_Resample48khzTo16khz(const int16_t* in, int16_t* out,
                                    YoumeWebRtcSpl_State48khzTo16khz* state,
                                    int32_t* tmpmem);

void YoumeWebRtcSpl_ResetResample48khzTo16khz(YoumeWebRtcSpl_State48khzTo16khz* state);

typedef struct {
  int32_t S_16_32[8];
  int32_t S_32_24[8];
  int32_t S_24_48[8];
} YoumeWebRtcSpl_State16khzTo48khz;

void YoumeWebRtcSpl_Resample16khzTo48khz(const int16_t* in, int16_t* out,
                                    YoumeWebRtcSpl_State16khzTo48khz* state,
                                    int32_t* tmpmem);

void YoumeWebRtcSpl_ResetResample16khzTo48khz(YoumeWebRtcSpl_State16khzTo48khz* state);
...
typedef struct {
  ...
  int32_t S_24_16[8];
  int32_t S_16_8[8];
} YoumeWebRtcSpl_State48khzTo8khz;

void YoumeWebRtcSpl_Resample48khzTo8khz(const int16_t* in, int16_t* out,
                                   YoumeWebRtcSpl_State48khzTo8khz* state,
                                   int32_t* tmpmem);

void YoumeWebRtcSpl_ResetResample48khzTo8khz(YoumeWebRtcSpl_State48khzTo8khz* state);
...
typedef struct {
  ...
  int32_t S_12_24[8];
  int32_t S_24_48[8];
} YoumeWebRtcSpl_State8khzTo48khz;

void YoumeWebRtcSpl_Resample8khzTo48khz(const int16_t* in, int16_t* out,
                                   YoumeWebRtcSpl_State8khzTo48khz* state,
                                   int32_t* tmpmem);

void YoumeWebRtcSpl_ResetResample8khzTo48khz(YoumeWebRtcSpl_State8khzTo48khz* state);
...
void YoumeWebRtcSpl_DownsampleBy2(const int16_t* in, size_t len,
                             int16_t* out, int32_t* filtState);

void YoumeWebRtcSpl_UpsampleBy2(const int16_t* in, size_t len,
                           int16_t* out, int32_t* filtState);
 ...
 *
 ******************************************************************/
void YoumeWebRtcSpl_32khzTo22khzIntToInt(const int32_t* In,
                                             int32_t* Out,
                                         int32_t K);
 ...
 ************************************************************/
void YoumeWebRtcSpl_AnalysisQMF(const int16_t* in_data,
                           size_t in_data_length,
                           int16_t* low_band,
                           int16_t* high_band,
                           int32_t* filter_state1,
                           int32_t* filter_state2);
void YoumeWebRtcSpl_SynthesisQMF(const int16_t* low_band,
...
//
// YoumeWebRtcSpl_AddSatW16(...)
// YoumeWebRtcSpl_AddSatW32(...)
//
...
//
// YoumeWebRtcSpl_SubSatW16(...)
// YoumeWebRtcSpl_SubSatW32(...)
//
...
//
// YoumeWebRtcSpl_GetScalingSquare(...)
//
...
//
// YoumeWebRtcSpl_MemCpyReversedOrder(...)
//
...
//
// YoumeWebRtcSpl_ZerosArrayW16(...)
// YoumeWebRtcSpl_ZerosArrayW32(...)
//
...
//
// YoumeWebRtcSpl_VectorBitShiftW16(...)
// YoumeWebRtcSpl_VectorBitShiftW32(...)
//
...
//
// YoumeWebRtcSpl_VectorBitShiftW32ToW16(...)
//
...
//
// YoumeWebRtcSpl_ScaleVectorWithSat(...)
//
// Performs the vector operation:
...
//
// YoumeWebRtcSpl_ScaleAndAddVectors(...)
//
// Performs the vector operation:
...
//
// YoumeWebRtcSpl_ReverseOrderMultArrayElements(...)
//
// Performs the vector operation:
...
//
// YoumeWebRtcSpl_ElementwiseVectorMult(...)
//
// Performs the vector operation:
//  out_vector[n] = (in_vector[n]*window[n])>>right_shifts
//
...
//
// YoumeWebRtcSpl_AddVectorsAndShift(...)
//
// Performs the vector operation:
...
//
// YoumeWebRtcSpl_AddAffineVectorToVector(...)
//
...
//
// YoumeWebRtcSpl_AffineTransformVector(...)
//
...
//
// YoumeWebRtcSpl_DivW32W16ResW16(...)
//
...
//                    since the table YoumeWebRtcSpl_kSinTable1024[] is 1024
//                    elements long.
//
...
// int16_t YoumeWebRtcSpl_SatW32ToW16(...)
//
...
// int32_t YoumeWebRtcSpl_MulAccumW16(...)
//
