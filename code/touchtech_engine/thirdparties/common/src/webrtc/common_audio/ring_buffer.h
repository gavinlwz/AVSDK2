...
void WebRtc_youme_InitBuffer(RingBuffer* handle);
...
size_t WebRtc_youme_ReadBuffer(RingBuffer* handle,
                         void** data_ptr,
                         void* data,
                         size_t element_count);

// Writes |data| to buffer and returns the number of elements written.
size_t WebRtc_youme_WriteBuffer(RingBuffer* handle, const void* data,
                          size_t element_count);
...
int WebRtc_youme_MoveReadPtr(RingBuffer* handle, int element_count);

// Returns number of available elements to read.
size_t WebRtc_youme_available_read(const RingBuffer* handle);

// Returns number of available elements for write.
size_t WebRtc_youme_available_write(const RingBuffer* handle);


int WebRtc_youme_MoveReadPtr_Back(RingBuffer* handle, int element_count);

size_t WebRtc_youme_get_write_pos(const RingBuffer* handle);

size_t WebRtc_youme_get_element_count(const RingBuffer* handle);
