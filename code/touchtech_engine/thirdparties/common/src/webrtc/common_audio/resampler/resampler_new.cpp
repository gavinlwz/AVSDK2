...
#include "webrtc/common_audio/resampler/include/resampler_new.h"
...
int Resampler::Reset(int inFreq, int outFreq, size_t num_channels) {
  ...
  switch (my_mode_) {
    ...
    case kResamplerMode1To3:
      state1_ = malloc(sizeof(YoumeWebRtcSpl_State16khzTo48khz));
      YoumeWebRtcSpl_ResetResample16khzTo48khz(
          static_cast<YoumeWebRtcSpl_State16khzTo48khz*>(state1_));
      break;
    ...
    case kResamplerMode1To6:
      ...
      memset(state1_, 0, 8 * sizeof(int32_t));
      // 2:6
      state2_ = malloc(sizeof(YoumeWebRtcSpl_State16khzTo48khz));
      YoumeWebRtcSpl_ResetResample16khzTo48khz(
          static_cast<YoumeWebRtcSpl_State16khzTo48khz*>(state2_));
      break;
    case kResamplerMode1To12:
      ...
      memset(state2_, 0, 8 * sizeof(int32_t));
      // 4:12
      state3_ = malloc(sizeof(YoumeWebRtcSpl_State16khzTo48khz));
      YoumeWebRtcSpl_ResetResample16khzTo48khz(
          static_cast<YoumeWebRtcSpl_State16khzTo48khz*>(state3_));
      break;
    ...
    case kResamplerMode2To11:
      ...
      state2_ = malloc(sizeof(YoumeWebRtcSpl_State8khzTo22khz));
      YoumeWebRtcSpl_ResetResample8khzTo22khz(
          static_cast<YoumeWebRtcSpl_State8khzTo22khz*>(state2_));
      break;
    case kResamplerMode4To11:
      state1_ = malloc(sizeof(YoumeWebRtcSpl_State8khzTo22khz));
      YoumeWebRtcSpl_ResetResample8khzTo22khz(
          static_cast<YoumeWebRtcSpl_State8khzTo22khz*>(state1_));
      break;
    case kResamplerMode8To11:
      state1_ = malloc(sizeof(YoumeWebRtcSpl_State16khzTo22khz));
      YoumeWebRtcSpl_ResetResample16khzTo22khz(
          static_cast<YoumeWebRtcSpl_State16khzTo22khz*>(state1_));
      break;
    case kResamplerMode11To16:
      state1_ = malloc(8 * sizeof(int32_t));
      memset(state1_, 0, 8 * sizeof(int32_t));

      state2_ = malloc(sizeof(YoumeWebRtcSpl_State22khzTo16khz));
      YoumeWebRtcSpl_ResetResample22khzTo16khz(
          static_cast<YoumeWebRtcSpl_State22khzTo16khz*>(state2_));
      break;
    ...
    case kResamplerMode3To1:
      state1_ = malloc(sizeof(YoumeWebRtcSpl_State48khzTo16khz));
      YoumeWebRtcSpl_ResetResample48khzTo16khz(
          static_cast<YoumeWebRtcSpl_State48khzTo16khz*>(state1_));
      break;
    ...
    case kResamplerMode3To2:
      ...
      memset(state1_, 0, 8 * sizeof(int32_t));
      // 6:2
      state2_ = malloc(sizeof(YoumeWebRtcSpl_State48khzTo16khz));
      YoumeWebRtcSpl_ResetResample48khzTo16khz(
          static_cast<YoumeWebRtcSpl_State48khzTo16khz*>(state2_));
      break;
    case kResamplerMode11To2:
      state1_ = malloc(sizeof(YoumeWebRtcSpl_State22khzTo8khz));
      YoumeWebRtcSpl_ResetResample22khzTo8khz(
          static_cast<YoumeWebRtcSpl_State22khzTo8khz*>(state1_));
    ...
    case kResamplerMode11To8:
      state1_ = malloc(sizeof(YoumeWebRtcSpl_State22khzTo16khz));
      YoumeWebRtcSpl_ResetResample22khzTo16khz(
          static_cast<YoumeWebRtcSpl_State22khzTo16khz*>(state1_));
      break;
  }
...
int Resampler::Push(const int16_t * samplesIn, size_t lengthIn,
  ...
  switch (my_mode_) {
    ...
    case kResamplerMode1To2:
      ...
      YoumeWebRtcSpl_UpsampleBy2(samplesIn, lengthIn, samplesOut,
    ...
    case kResamplerMode1To3:
      ...
      for (size_t i = 0; i < lengthIn; i += 160) {
        YoumeWebRtcSpl_Resample16khzTo48khz(
            samplesIn + i, samplesOut + i * 3,
            static_cast<YoumeWebRtcSpl_State16khzTo48khz*>(state1_), tmp_mem);
      }
      outLen = lengthIn * 3;
      free(tmp_mem);
      return 0;
    case kResamplerMode1To4:
      ...
      // 1:2
      YoumeWebRtcSpl_UpsampleBy2(samplesIn, lengthIn, tmp,
                            static_cast<int32_t*>(state1_));
      // 2:4
      YoumeWebRtcSpl_UpsampleBy2(tmp, lengthIn * 2, samplesOut,
    ...
    case kResamplerMode1To6:
      ...
      for (size_t i = 0; i < outLen; i += 160) {
        YoumeWebRtcSpl_Resample16khzTo48khz(
            ...
            static_cast<YoumeWebRtcSpl_State16khzTo48khz*>(state2_), tmp_mem);
      }
      outLen = outLen * 3;
      free(tmp_mem);
      free(tmp);
    ...
    case kResamplerMode1To12:
      ...
      outLen = lengthIn * 2;
      // 2:4
      YoumeWebRtcSpl_UpsampleBy2(samplesOut, outLen, tmp,
                            static_cast<int32_t*>(state2_));
      outLen = outLen * 2;
      // 4:12
      for (size_t i = 0; i < outLen; i += 160) {
        // YoumeWebRtcSpl_Resample16khzTo48khz() takes a block of 160 samples
        ...
        YoumeWebRtcSpl_Resample16khzTo48khz(
            tmp + i, samplesOut + i * 3,
            static_cast<YoumeWebRtcSpl_State16khzTo48khz*>(state3_), tmp_mem);
      }
      outLen = outLen * 3;
      free(tmp_mem);
      free(tmp);
    ...
    case kResamplerMode2To3:
      ...
      lengthIn = lengthIn * 3;
      // 6:3
      YoumeWebRtcSpl_DownsampleBy2(tmp, lengthIn, samplesOut,
                              static_cast<int32_t*>(state2_));
      outLen = lengthIn / 2;
      free(tmp);
      free(tmp_mem);
    ...
    case kResamplerMode2To11:
      ...
      for (size_t i = 0; i < lengthIn; i += 80) {
        YoumeWebRtcSpl_Resample8khzTo22khz(
            tmp + i, samplesOut + (i * 11) / 4,
            static_cast<YoumeWebRtcSpl_State8khzTo22khz*>(state2_), tmp_mem);
      }
    ...
    case kResamplerMode4To11:
      ...
      for (size_t i = 0; i < lengthIn; i += 80) {
        YoumeWebRtcSpl_Resample8khzTo22khz(
            ...
            static_cast<YoumeWebRtcSpl_State8khzTo22khz*>(state1_), tmp_mem);
      }
      outLen = (lengthIn * 11) / 4;
      free(tmp_mem);
      return 0;
    case kResamplerMode8To11:
      ...
      for (size_t i = 0; i < lengthIn; i += 160) {
        YoumeWebRtcSpl_Resample16khzTo22khz(
            samplesIn + i, samplesOut + (i * 11) / 8,
            static_cast<YoumeWebRtcSpl_State16khzTo22khz*>(state1_), tmp_mem);
      }
    ...
    case kResamplerMode11To16:
      ...
      for (size_t i = 0; i < (lengthIn * 2); i += 220) {
        YoumeWebRtcSpl_Resample22khzTo16khz(
            tmp + i, samplesOut + (i / 220) * 160,
            static_cast<YoumeWebRtcSpl_State22khzTo16khz*>(state2_), tmp_mem);
      }
    ...
    case kResamplerMode11To32:
      ...
      // 16 -> 32 in samplesOut
      YoumeWebRtcSpl_UpsampleBy2(tmp, (lengthIn * 16) / 11, samplesOut,
    ...
    case kResamplerMode2To1:
      ...
      YoumeWebRtcSpl_DownsampleBy2(samplesIn, lengthIn, samplesOut,
                              static_cast<int32_t*>(state1_));
      outLen = lengthIn / 2;
      return 0;
    case kResamplerMode3To1:
      ...
      for (size_t i = 0; i < lengthIn; i += 480) {
        YoumeWebRtcSpl_Resample48khzTo16khz(
            samplesIn + i, samplesOut + i / 3,
            static_cast<YoumeWebRtcSpl_State48khzTo16khz*>(state1_), tmp_mem);
      }
      outLen = lengthIn / 3;
      free(tmp_mem);
      return 0;
    case kResamplerMode4To1:
      ...
      tmp = static_cast<int16_t*>(malloc(sizeof(int16_t) * lengthIn / 2));
      // 4:2
      YoumeWebRtcSpl_DownsampleBy2(samplesIn, lengthIn, tmp,
                              static_cast<int32_t*>(state1_));
      // 2:1
      YoumeWebRtcSpl_DownsampleBy2(tmp, lengthIn / 2, samplesOut,
                              static_cast<int32_t*>(state2_));
      outLen = lengthIn / 4;
      free(tmp);
      return 0;
    ...
    case kResamplerMode6To1:
      ...
      outLen = lengthIn / 3;
      free(tmp_mem);
      YoumeWebRtcSpl_DownsampleBy2(tmp, outLen, samplesOut,
                              static_cast<int32_t*>(state2_));
      free(tmp);
      outLen = outLen / 2;
      return 0;
    case kResamplerMode12To1:
      ...
      // 12:4
      for (size_t i = 0; i < lengthIn; i += 480) {
        // YoumeWebRtcSpl_Resample48khzTo16khz() takes a block of 480 samples
      ...
      free(tmp_mem);
      // 4:2
      YoumeWebRtcSpl_DownsampleBy2(tmp, outLen, tmp_2,
                              static_cast<int32_t*>(state2_));
      outLen = outLen / 2;
      free(tmp);
      // 2:1
      YoumeWebRtcSpl_DownsampleBy2(tmp_2, outLen, samplesOut,
                              static_cast<int32_t*>(state3_));
      free(tmp_2);
      outLen = outLen / 2;
      return 0;
    case kResamplerMode3To2:
      ...
      for (size_t i = 0; i < lengthIn; i += 480) {
        YoumeWebRtcSpl_Resample48khzTo16khz(
            tmp + i, samplesOut + i / 3,
            static_cast<YoumeWebRtcSpl_State48khzTo16khz*>(state2_), tmp_mem);
      }
      outLen = lengthIn / 3;
      free(tmp);
      free(tmp_mem);
    ...
    case kResamplerMode11To2:
      ...
      for (size_t i = 0; i < lengthIn; i += 220) {
        YoumeWebRtcSpl_Resample22khzTo8khz(
            samplesIn + i, tmp + (i * 4) / 11,
            static_cast<YoumeWebRtcSpl_State22khzTo8khz*>(state1_), tmp_mem);
      }
    ...
    case kResamplerMode11To8:
      ...
      for (size_t i = 0; i < lengthIn; i += 220) {
        YoumeWebRtcSpl_Resample22khzTo16khz(
            ...
            static_cast<YoumeWebRtcSpl_State22khzTo16khz*>(state1_), tmp_mem);
      }
