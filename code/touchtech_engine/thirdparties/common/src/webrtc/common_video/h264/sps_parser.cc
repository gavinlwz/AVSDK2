/*
 *  Copyright (c) 2016 The WebRTC@AnyRTC project authors. All Rights Reserved.
 *
...
typedef rtc::Optional<youme::webrtc::SpsParser::SpsState> OptionalSps;
...
rtc::Optional<SpsParser::SpsState> SpsParser::ParseSpsUpToVui(
  ...
  // level_idc: u(8)
  //RETURN_EMPTY_ON_FAIL(buffer->ConsumeBytes(1));
  RETURN_EMPTY_ON_FAIL(buffer->ReadUInt8(&level_idc));
