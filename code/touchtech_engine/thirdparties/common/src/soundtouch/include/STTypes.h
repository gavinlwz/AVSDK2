...
////////////////////////////////////////////////////////////////////////////////
//
// Last changed  : $Date: 2014-01-07 13:24:28 -0500 (Tue, 07 Jan 2014) $
...
#if (defined(__GNUC__) && (!defined(ANDROID) && !defined(TARGET_OS_IPHONE) && !defined(IOS) && !defined(MAC_OS) && !defined(OS_LINUX)))
// In GCC, include soundtouch_config.h made by config scritps.
// Skip this in Android and iOS compilation that uses GCC but without configure scripts.
#include "soundtouch_config.h"
#elif defined(TARGET_OS_IPHONE) || defined(IOS) || defined(MAC_OS)
