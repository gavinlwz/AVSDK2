...
// Old filter design, there is jitter in the pass band
//static const int16_t kHpZeroCoefs[3] = { 6631, -13262, 6631 };
//static const int16_t kHpPoleCoefs[3] = { 16384, -7756, 5620 };
// New filter design, No jitter in the pass band
static const int16_t kHpZeroCoefs[3] = { 7878, -15755, 7878 };
static const int16_t kHpPoleCoefs[3] = { 16384, -10994, 4133 };
...
static void LogOfEnergy(const int16_t* data_in, size_t data_length,
  ...
  energy = (uint32_t) YoumeWebRtcSpl_Energy((int16_t*) data_in, data_length,
                                       &tot_rshifts);

  if (energy != 0) {
    // By construction, normalizing to 15 bits is equivalent with 17 leading
    // zeros of an unsigned 32 bit value.
    int normalizing_rshifts = 17 - YoumeWebRtcSpl_NormU32(energy);
