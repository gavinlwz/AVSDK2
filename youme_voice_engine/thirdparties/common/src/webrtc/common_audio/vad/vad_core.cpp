...
static const int16_t kLocalThresholdVAG[3] = { 85, 85, 85 };
static const int16_t kGlobalThresholdVAG[3] = { 875, 850, 875 };
...
static int16_t GmmProbability(VadInstT* self, int16_t* features,
  ...
  if (total_power > kMinEnergy) {
    ...
    for (channel = 0; channel < kNumChannels; channel++) {
      ...
      // cancel.
      shifts_h0 = YoumeWebRtcSpl_NormW32(h0_test);
      shifts_h1 = YoumeWebRtcSpl_NormW32(h1_test);
      if (h0_test == 0) {
        shifts_h0 = 31;
      }
      if (h1_test == 0) {
      ...
      if (h0 > 0) {
        ...
        ngprvec[channel] = (int16_t) YoumeWebRtcSpl_DivW32W16(tmp1_s32, h0);  // Q14
      ...
      if (h1 > 0) {
        ...
        sgprvec[channel] = (int16_t) YoumeWebRtcSpl_DivW32W16(tmp1_s32, h1);  // Q14
    ...
    for (channel = 0; channel < kNumChannels; channel++) {
      ...
      for (k = 0; k < kNumGaussians; k++) {
        ...
        if (vadflag) {
          ...
          // 0.1 * Q20 / Q7 = Q13.
          if (tmp2_s32 > 0) {
            tmp_s16 = (int16_t) YoumeWebRtcSpl_DivW32W16(tmp2_s32, ssk * 10);
          } else {
            tmp_s16 = (int16_t) YoumeWebRtcSpl_DivW32W16(-tmp2_s32, ssk * 10);
            tmp_s16 = -tmp_s16;
          }
          ...
          // Q20 / Q7 = Q13.
          if (tmp1_s32 > 0) {
            tmp_s16 = (int16_t) YoumeWebRtcSpl_DivW32W16(tmp1_s32, nsk);
          } else {
            tmp_s16 = (int16_t) YoumeWebRtcSpl_DivW32W16(-tmp1_s32, nsk);
            tmp_s16 = -tmp_s16;
          }
...
int WebRtcVad_InitCore(VadInstT* self) {
  ...
  YoumeWebRtcSpl_ResetResample48khzTo8khz(&self->state_48_to_8);
...
int WebRtcVad_CalcVad48khz(VadInstT* inst, const int16_t* speech_frame,
  ...
  for (i = 0; i < num_10ms_frames; i++) {
    YoumeWebRtcSpl_Resample48khzTo8khz(speech_frame,
