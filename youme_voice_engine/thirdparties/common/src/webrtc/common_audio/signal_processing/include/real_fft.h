...
struct RealFFT;
typedef struct RealFFT RealFFT_s;
...
// function with YoumeWebRtcSpl_CreateRealFFT().
...
// FFT function with YoumeWebRtcSpl_CreateRealFFT().
...
// YoumeWebRtcSpl_RealForwardFFTC above.
//
// Input Arguments:
//   self - pointer to preallocated and initialized FFT specification structure.
