...
/*
 * This file contains the function YoumeWebRtcSpl_ComplexFFT().
...
int YoumeWebRtcSpl_ComplexFFT(int16_t frfi[], int stages, int mode)
{
...
int YoumeWebRtcSpl_ComplexIFFT(int16_t frfi[], int stages, int mode)
{
    ...
    while (l < n)
    {
        ...
        tmp32 = YoumeWebRtcSpl_MaxAbsValueW16(frfi, 2 * n);
        if (tmp32 > 13573)
        {
            shift++;
            scale++;
