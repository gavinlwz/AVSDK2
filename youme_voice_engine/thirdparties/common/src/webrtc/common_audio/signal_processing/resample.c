...
static void YoumeWebRtcSpl_32khzTo22khzIntToShort(const int32_t *In, int16_t *Out,
                                             int32_t K);

void YoumeWebRtcSpl_32khzTo22khzIntToInt(const int32_t *In, int32_t *Out,
                                    int32_t K);
...
// 22 -> 16 resampler
void YoumeWebRtcSpl_Resample22khzTo16khz(const int16_t* in, int16_t* out,
                                    YoumeWebRtcSpl_State22khzTo16khz* state, int32_t* tmpmem)
{
    int k;
    ...
    for (k = 0; k < SUB_BLOCKS_22_16; k++)
    {
        ...
        /////
        YoumeWebRtcSpl_UpBy2ShortToInt(in, 220 / SUB_BLOCKS_22_16, tmpmem + 16, state->S_22_44);
        ...
        YoumeWebRtcSpl_Resample44khzTo32khz(tmpmem + 8, tmpmem, 40 / SUB_BLOCKS_22_16);

        ///// 32 --> 16 /////
        // int32_t  in[320/SUB_BLOCKS_22_16]
        // int32_t out[160/SUB_BLOCKS_22_16]
        /////
        YoumeWebRtcSpl_DownBy2IntToShort(tmpmem, 320 / SUB_BLOCKS_22_16, out, state->S_32_16);
...
// 16 -> 22 resampler
void YoumeWebRtcSpl_Resample16khzTo22khz(const int16_t* in, int16_t* out,
                                    YoumeWebRtcSpl_State16khzTo22khz* state, int32_t* tmpmem)
{
    int k;
    ...
    for (k = 0; k < SUB_BLOCKS_16_22; k++)
    {
        ...
        /////
        YoumeWebRtcSpl_UpBy2ShortToInt(in, 160 / SUB_BLOCKS_16_22, tmpmem + 8, state->S_16_32);
        ...
        YoumeWebRtcSpl_32khzTo22khzIntToShort(tmpmem, out, 20 / SUB_BLOCKS_16_22);
...
void YoumeWebRtcSpl_Resample22khzTo8khz(const int16_t* in, int16_t* out,
                                   YoumeWebRtcSpl_State22khzTo8khz* state, int32_t* tmpmem)
{
    int k;
    ...
    for (k = 0; k < SUB_BLOCKS_22_8; k++)
    {
        ...
        /////
        YoumeWebRtcSpl_LPBy2ShortToInt(in, 220 / SUB_BLOCKS_22_8, tmpmem + 16, state->S_22_22);
        ...
        YoumeWebRtcSpl_Resample44khzTo32khz(tmpmem + 8, tmpmem, 20 / SUB_BLOCKS_22_8);

        ///// 16 --> 8 /////
        // int32_t in[160/SUB_BLOCKS_22_8]
        // int32_t out[80/SUB_BLOCKS_22_8]
        /////
        YoumeWebRtcSpl_DownBy2IntToShort(tmpmem, 160 / SUB_BLOCKS_22_8, out, state->S_16_8);
...
void YoumeWebRtcSpl_Resample8khzTo22khz(const int16_t* in, int16_t* out,
                                   YoumeWebRtcSpl_State8khzTo22khz* state, int32_t* tmpmem)
{
    int k;
    ...
    for (k = 0; k < SUB_BLOCKS_8_22; k++)
    {
        ...
        /////
        YoumeWebRtcSpl_UpBy2ShortToInt(in, 80 / SUB_BLOCKS_8_22, tmpmem + 18, state->S_8_16);
        ...
        YoumeWebRtcSpl_32khzTo22khzIntToInt(tmpmem + 10, tmpmem, 10 / SUB_BLOCKS_8_22);

        ///// 11 --> 22 /////
        // int32_t  in[110/SUB_BLOCKS_8_22]
        // int16_t out[220/SUB_BLOCKS_8_22]
        /////
        YoumeWebRtcSpl_UpBy2IntToShort(tmpmem, 110 / SUB_BLOCKS_8_22, out, state->S_11_22);
...
static void YoumeWebRtcSpl_DotProdIntToInt(const int32_t* in1, const int32_t* in2,
...
// compute two inner-products and store them to output array
static void YoumeWebRtcSpl_DotProdIntToShort(const int32_t* in1, const int32_t* in2,
                                    ...
                                    int32_t K)
{
    ...
    for (m = 0; m < K; m++)
    {
        ...
        YoumeWebRtcSpl_DotProdIntToInt(&In[0], &In[22], kCoefficients32To22[0], &Out[1], &Out[10]);

        // sum and accumulate filter coefficients and input samples
        YoumeWebRtcSpl_DotProdIntToInt(&In[2], &In[20], kCoefficients32To22[1], &Out[2], &Out[9]);

        // sum and accumulate filter coefficients and input samples
        YoumeWebRtcSpl_DotProdIntToInt(&In[3], &In[19], kCoefficients32To22[2], &Out[3], &Out[8]);

        // sum and accumulate filter coefficients and input samples
        YoumeWebRtcSpl_DotProdIntToInt(&In[5], &In[17], kCoefficients32To22[3], &Out[4], &Out[7]);

        // sum and accumulate filter coefficients and input samples
        YoumeWebRtcSpl_DotProdIntToInt(&In[6], &In[16], kCoefficients32To22[4], &Out[5], &Out[6]);
...
void YoumeWebRtcSpl_32khzTo22khzIntToShort(const int32_t *In,
                                      int16_t *Out,
                                      int32_t K)
{
    /////////////////////////////////////////////////////////////
    ...
    for (m = 0; m < K; m++)
    {
        ...
        // sum and accumulate filter coefficients and input samples
        YoumeWebRtcSpl_DotProdIntToShort(&In[0], &In[22], kCoefficients32To22[0], &Out[1], &Out[10]);

        // sum and accumulate filter coefficients and input samples
        YoumeWebRtcSpl_DotProdIntToShort(&In[2], &In[20], kCoefficients32To22[1], &Out[2], &Out[9]);

        // sum and accumulate filter coefficients and input samples
        YoumeWebRtcSpl_DotProdIntToShort(&In[3], &In[19], kCoefficients32To22[2], &Out[3], &Out[8]);

        // sum and accumulate filter coefficients and input samples
        YoumeWebRtcSpl_DotProdIntToShort(&In[5], &In[17], kCoefficients32To22[3], &Out[4], &Out[7]);

        // sum and accumulate filter coefficients and input samples
        YoumeWebRtcSpl_DotProdIntToShort(&In[6], &In[16], kCoefficients32To22[4], &Out[5], &Out[6]);
