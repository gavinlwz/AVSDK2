...
/*
 * This file contains the function YoumeWebRtcSpl_Sqrt().
...
int32_t YoumeWebRtcSpl_SqrtLocal(int32_t in);
...
int32_t YoumeWebRtcSpl_Sqrt(int32_t value)
{
    ...
    sh = YoumeWebRtcSpl_NormW32(A); // # shifts to normalize A
    ...
    A = YoumeWebRtcSpl_SqrtLocal(A); // A = sqrt(A)
