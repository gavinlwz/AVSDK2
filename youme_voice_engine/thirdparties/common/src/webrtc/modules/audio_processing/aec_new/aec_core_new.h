...
#ifndef WEBRTC_MODULES_AUDIO_PROCESSING_AEC_AEC_CORE_NEW_H_
#define WEBRTC_MODULES_AUDIO_PROCESSING_AEC_AEC_CORE_NEW_H_
...
// A helper function to call WebRtc_youme_MoveReadPtr() for all far-end buffers.
...
void* WebRtcAec_media_time_buf(AecCore* self);
...
int WebRtcAec_FarPlayOutDelta(AecCore* self);
#endif
#ifdef DEBUG_RECORD
...
#endif  // WEBRTC_MODULES_AUDIO_PROCESSING_AEC_AEC_CORE_NEW_H_
