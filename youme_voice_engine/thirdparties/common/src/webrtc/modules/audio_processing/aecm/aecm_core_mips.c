...
static void WindowAndFFT(AecmCore* aecm,
  ...
  YoumeWebRtcSpl_ComplexFFT(fft, PART_LEN_SHIFT, 1);
  pfrfi = fft;
...
static void InverseFFTAndWindow(AecmCore* aecm,
  ...
  outCFFT = YoumeWebRtcSpl_ComplexIFFT(fft, PART_LEN_SHIFT, 1);
  pfft = fft;
...
static int TimeToFrequencyDomain(AecmCore* aecm,
  ...
  tmp32no10 = YoumeWebRtcSpl_SqrtFloor(tmp32no20);
  tmp32no11 = YoumeWebRtcSpl_SqrtFloor(tmp32no21);
  tmp32no12 = YoumeWebRtcSpl_SqrtFloor(tmp32no22);
  ...
  for (i = 4; i < PART_LEN; i+=4)
  {
    ...
    tmp32no11 = YoumeWebRtcSpl_SqrtFloor(tmp32no21);
    tmp32no12 = YoumeWebRtcSpl_SqrtFloor(tmp32no22);
    tmp32no13 = YoumeWebRtcSpl_SqrtFloor(tmp32no23);
