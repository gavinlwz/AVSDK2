 ...
 *                          : -1 - Error
 */
int WebRtcAgc_AddMic (void *agcInst, int16_t *inMic, size_t num_bands, size_t samples);
 ...
 *                          : -1 - Error
 */
int WebRtcAgc_VirtualMic (void *agcInst, int16_t *inMic, size_t num_bands, size_t samples, int32_t micLevelIn, int32_t *micLevelOut);
 ...
 *                          : -1 - Error
 */
int WebRtcAgc_Process (void *agcInst, const int16_t* const* inNear, size_t num_bands, size_t samples, int16_t* const* out, int32_t inMicLevel, int32_t *outMicLevel, int16_t echo, uint8_t *saturationWarning);
