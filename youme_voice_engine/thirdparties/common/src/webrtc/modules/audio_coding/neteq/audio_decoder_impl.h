...
// Creates an AudioDecoder object of type |codec_type| with sampling frequency |fs_hz|.
// Returns NULL for for unsupported codecs, and when creating an AudioDecoder is not applicable
// (e.g., for RED and DTMF/AVT types).
AudioDecoder* CreateAudioDecoder(NetEqDecoder codec_type, int32_t fs_hz);
