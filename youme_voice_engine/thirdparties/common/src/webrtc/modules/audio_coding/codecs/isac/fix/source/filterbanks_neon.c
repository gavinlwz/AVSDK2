...
//
//  b0_ch1 = YoumeWebRtcSpl_AddSatW32(a0_ch1, state0_ch1);
//  b0_ch2 = YoumeWebRtcSpl_AddSatW32(a0_ch2, state0_ch2); //Q16+Q16=Q16
//
//  a0_ch1 = -factor_ch1[0] * (int16_t)(b0_ch1 >> 16);
//  a0_ch2 = -factor_ch2[0] * (int16_t)(b0_ch2 >> 16);
//
//  state0_ch1 = YoumeWebRtcSpl_AddSatW32(a0_ch1 <<1, (uint32_t)sample0_ch1 << 16);
//  state0_ch2 = YoumeWebRtcSpl_AddSatW32(a0_ch2 <<1, (uint32_t)sample0_ch2 << 16);
//
...
//
//    b1_ch1 = YoumeWebRtcSpl_AddSatW32(a1_ch1, state0_ch1);
//    b0_ch1 = YoumeWebRtcSpl_AddSatW32(a0_ch1, state1_ch1); //Q16+Q16=Q16
//    b1_ch2 = YoumeWebRtcSpl_AddSatW32(a1_ch2, state0_ch2); //Q16+Q16=Q16
//    b0_ch2 = YoumeWebRtcSpl_AddSatW32(a0_ch2, state1_ch2); //Q16+Q16=Q16
//
...
//
//    state0_ch1 = YoumeWebRtcSpl_AddSatW32(a1_ch1<<1, (uint32_t)sample1_ch1 <<16);
//    state1_ch1 = YoumeWebRtcSpl_AddSatW32(a0_ch1<<1, (uint32_t)sample0_ch1 <<16);
//    state0_ch2 = YoumeWebRtcSpl_AddSatW32(a1_ch2<<1, (uint32_t)sample1_ch2 <<16);
//    state1_ch2 = YoumeWebRtcSpl_AddSatW32(a0_ch2<<1, (uint32_t)sample0_ch2 <<16);
//
...
//
//    b2_ch1 = YoumeWebRtcSpl_AddSatW32(a0_ch1, state0_ch1);
//    b1_ch1 = YoumeWebRtcSpl_AddSatW32(a1_ch1, state1_ch1); //Q16+Q16=Q16
//    b2_ch2 = YoumeWebRtcSpl_AddSatW32(a0_ch2, state0_ch2); //Q16+Q16=Q16
//    b1_ch2 = YoumeWebRtcSpl_AddSatW32(a1_ch2, state1_ch2); //Q16+Q16=Q16
//
...
//
//    state0_ch1 = YoumeWebRtcSpl_AddSatW32(a0_ch1<<1, (uint32_t)sample0_ch1<<16);
//    state1_ch1 = YoumeWebRtcSpl_AddSatW32(a1_ch1<<1, (uint32_t)sample1_ch1<<16);
//    state0_ch2 = YoumeWebRtcSpl_AddSatW32(a0_ch2<<1, (uint32_t)sample0_ch2<<16);
//    state1_ch2 = YoumeWebRtcSpl_AddSatW32(a1_ch2<<1, (uint32_t)sample1_ch2<<16);
//
//
...
//
//  b1_ch1 = YoumeWebRtcSpl_AddSatW32(a1_ch1, state0_ch1);
//  b0_ch1 = YoumeWebRtcSpl_AddSatW32(a0_ch1, state1_ch1);
//  b1_ch2 = YoumeWebRtcSpl_AddSatW32(a1_ch2, state0_ch2);
//  b0_ch2 = YoumeWebRtcSpl_AddSatW32(a0_ch2, state1_ch2);
//
//  a1_ch1 = -factor_ch1[0] * (int16_t)(b1_ch1 >> 16);
//  a0_ch1 = -factor_ch1[1] * (int16_t)(b0_ch1 >> 16);
//  a1_ch2 = -factor_ch2[0] * (int16_t)(b1_ch2 >> 16);
