...
TINYNET_API tnet_addresses_L_t *tnet_get_addresses (tnet_family_t family, tsk_bool_t unicast, tsk_bool_t anycast, tsk_bool_t multicast, long if_index);
...
#define tnet_get_addresses_unicast4() tnet_get_addresses (AF_INET, 0, 1, 0, 0, 0, -1)
#define tnet_get_addresses_wifi_unicast4() tnet_get_addresses (AF_INET, 1, 1, 0, 0, 0, -1)
#define tnet_get_addresses_unicast6() tnet_get_addresses (AF_INET6, 0, 1, 0, 0, 0, -1)
#define tnet_get_addresses_all_anycast() tnet_get_addresses (AF_UNSPEC, 0, 0, 1, 0, 0, -1)
#define tnet_get_addresses_anycast4() tnet_get_addresses (AF_INET, 0, 0, 1, 0, 0, -1)
#define tnet_get_addresses_anycast6() tnet_get_addresses (AF_INET6, 0, 0, 1, 0, 0, -1)
#define tnet_get_addresses_all_multicast() tnet_get_addresses (AF_UNSPEC, 0, 0, 0, 1, 0, -1)
#define tnet_get_addresses_multicast4() tnet_get_addresses (AF_INET, 0, 0, 0, 1, 0, -1)
#define tnet_get_addresses_multicast6() tnet_get_addresses (AF_INET6, 0, 0, 0, 1, 0, -1)
...
#else
#define tnet_get_sockaddr_size(psockaddr) \
    ((psockaddr)->sa_family == AF_INET6 ? sizeof (struct sockaddr_in6) : ((psockaddr)->sa_family == AF_INET ? sizeof (struct sockaddr_in) : sizeof (*(psockaddr))))
#endif
