...
function buildJar(){
    ...
    if [ -f ../bindings/cocos2d-x/java/build/libs/youme_voice_engine.jar ]; then
        cp ../bindings/cocos2d-x/java/build/libs/youme_voice_engine.jar $LIB_PATH/android/youme_voice_engine.jar
        cp ../bindings/cocos2d-x/java/libs/android-support-v4.jar $LIB_PATH/android/android-support-v4.jar
