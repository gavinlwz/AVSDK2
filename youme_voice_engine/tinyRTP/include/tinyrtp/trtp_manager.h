...
typedef enum trtp_engine_event_type_s
{
	TRTP_ENGINE_EVENT_TYPE_VIDEO_ON = 0x10,
} trtp_engine_event_type_t;
...
TINYRTP_API int trtp_manager_set_video_nack_check_callback(trtp_manager_t *self, trtp_rtp_nack_check_cb_f fun, const void *usrdata);
//设置jb回调接口
