...
#define TRTP_RTCP_REPORT_SR_SENDINFO_LEN     36 // no block
...
typedef struct trtp_rtcp_report_sr_s {
    ...
    struct {
        ...
        uint32_t audio_sender_pcount; /**< sender's packet count */
        uint32_t audio_sender_ocount; /**< sender's octet count */
        uint32_t video_sender_pcount; /**< sender's packet count */
        uint32_t video_sender_ocount; /**< sender's octet count */
        uint32_t minor_video_sender_pcount; /**< sender's packet count */
        uint32_t minor_video_sender_ocount; /**< sender's octet count */
    } sender_info;
