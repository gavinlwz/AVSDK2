...
bool MediaSessionMgr::getVideoNetResolutionForShare( uint32_t &width, uint32_t &height )
{
...
void MediaSessionMgr::defaultsSetVideoNackFlag (uint32_t nack)
{
    tmedia_set_video_nack_flag(nack);
}