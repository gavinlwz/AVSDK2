...
string NgnConfigurationEntry::VIDEO_NACK_FLAG = "nack";
...
#if defined(__APPLE__)
int NgnConfigurationEntry::DEFAULT_GENERAL_ECHO_TAIL = 45;
#elif defined(WIN32)
int NgnConfigurationEntry::DEFAULT_GENERAL_ECHO_TAIL = 80;
#elif defined(ANDROID)
int NgnConfigurationEntry::DEFAULT_GENERAL_ECHO_TAIL = 150;
#else
...
int NgnConfigurationEntry::DEFAULT_GENERAL_AGC_TARGET_LEVEL = 5;
...
uint32_t NgnConfigurationEntry::DEFAULT_VIDEO_NACK_FLAG = 1;    // 默认启动nack半程重传
...
int NgnConfigurationEntry::DEFAULT_TIMEOUT_COUNT=3;
