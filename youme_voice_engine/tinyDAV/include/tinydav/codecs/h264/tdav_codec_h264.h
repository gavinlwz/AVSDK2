...
#define HAVE_H264_PASSTHROUGH

#if defined(HAVE_FFMPEG) || defined(HAVE_H264_PASSTHROUGH)
...
//void tdav_youme_audio_report_timestamp(int32_t sessionId, uint32_t timestamp);
