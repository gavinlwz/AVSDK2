...
/*
 * This file contains the function YoumeWebRtcSpl_LpcToReflCoef().
...
void YoumeWebRtcSpl_LpcToReflCoef(int16_t* a16, int use_order, int16_t* k16)
{
    int m, k;
    ...
    for (m = use_order - 1; m > 0; m--)
    {
        ...
        for (k = 1; k <= m; k++)
        {
            ...
            tmp32[k] = YoumeWebRtcSpl_DivW32W16(tmp32[k], tmp_inv_denom16); //Q28/Q15 = Q13
        }
