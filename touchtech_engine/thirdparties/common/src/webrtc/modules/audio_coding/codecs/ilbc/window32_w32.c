...
void WebRtcIlbcfix_Window32W32(
  ...
  left_shifts = (int16_t)YoumeWebRtcSpl_NormW32(x[0]);
  YoumeWebRtcSpl_VectorBitShiftW32(x, N, x, (int16_t)(-left_shifts));
  ...
  YoumeWebRtcSpl_VectorBitShiftW32(z, N, z, left_shifts);
