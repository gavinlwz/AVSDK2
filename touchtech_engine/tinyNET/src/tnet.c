...
* You MUST call @ref tnet_startup() before using any network function (tnet_*). tnet_cleanup() is
*used to terminate use of network functions. <br>
* The startup function will determine whether the host is a little-endian machine or not (at
*runtime).
*
* ======
*
...
/**
 * @fn tnet_startup
 * This is probably the most important function. You MUST call this function to initialize the
*network stack before calling any <b>tnet_*</b> function. <br />
 * On windows, this function will call <a target=_blank
*href="http://msdn.microsoft.com/en-us/library/windows/desktop/ms742213(v=vs.85).aspx">WSAStartup</a>.
*<br />
 * You MUST call @ref tnet_cleanup to cleanup the network stack if you no longer need to use
*networking function.
 *
 * @sa @ref tnet_cleanup.
 ...
 * On windows, this function will call <a target=_blank
*href="http://msdn.microsoft.com/en-us/library/windows/desktop/ms741549(v=vs.85).aspx">WSACleanup</a>.
*<br />
 * @sa @ref tnet_startup.
