...
public class ScreenCapturerAndroid
        implements VideoBaseCapturer, SurfaceTextureHelper.OnTextureFrameAvailableListener {
    ...
    public synchronized void initialize(final SurfaceTextureHelper surfaceTextureHelper,
                                        final Context applicationContext, final VideoBaseCapturer.CapturerObserver capturerObserver) {
        checkNotDisposed();
