...
public class GlUtil {
    ...
    public static int createProgram(String vertexSource, String fragmentSource) {
        ...
        if (vertexShader == 0) {
        	Log.e(TAG, "Could not loadshader vertex source");
        	GlUtil.checkGlError("createProgram loadShader vertex");
            return 0;
        }
        int pixelShader = loadShader(GLES20.GL_FRAGMENT_SHADER, fragmentSource);
        if (pixelShader == 0) {
        	Log.e(TAG, "Could not loadshader fragment source");
        	GlUtil.checkGlError("createProgram loadShader fragment");
            return 0;
        }
