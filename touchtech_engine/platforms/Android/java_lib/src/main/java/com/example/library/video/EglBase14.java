...
public final class EglBase14 extends EglBase {
    ...
    private static EGLContext createEglContext(
        ...
        EGLContext rootContext = sharedContext == null || sharedContext.egl14Context == null ?
        		EGL14.EGL_NO_CONTEXT : sharedContext.egl14Context;
    ...
    synchronized (EglBase.lock) {
        ...
        if (eglContext == EGL14.EGL_NO_CONTEXT) {
        	throw new RuntimeException(
                    "eglContext2 Failed to create EGL context: 0x" + Integer.toHexString(EGL14.eglGetError()));

//        	final EGLContext eglContext2;
//        	synchronized (lock) {
//        		eglContext2 = EGL14.eglCreateContext(eglDisplay, eglConfig, EGL14.eglGetCurrentContext(), contextAttributes, 0);
//            }
