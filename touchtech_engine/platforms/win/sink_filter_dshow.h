...
#ifndef __WINDOWS_SINK_FILTER_DSHOW_H__
#define __WINDOWS_SINK_FILTER_DSHOW_H__

#include "video_capture_dshow.h"
#include "./DShow/include/streams.h" // Include base DS filter header files
...
#endif // __WINDOWS_SINK_FILTER_DSHOW_H__
